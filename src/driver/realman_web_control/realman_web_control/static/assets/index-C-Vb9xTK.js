...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Dg(i,e,t){const n=new Float32Array(pi),s=new I(0,1,0);return new En({name:"SphericalGaussianBlur",defines:{n:pi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Yr(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Ac(){return new En({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yr(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function wc(){return new En({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yr(),fragmentShader:`
	...
	`}class qh extends bn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Lh(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new bt(c,l),d=new qr(-1,1,1,-1,0,1);let u=null,f=null,g=!1,M,m=null,p=[],S=!1;this.setSize=function(A,v){a.setSize(A,v),o.setSize(A,v);for(let E=0;E<p.length;E++){const T=p[E];T.setSize&&T.setSize(A,v)}},this.setEffects=function(A){p=A,S=p.length>0&&p[0].isRenderPass===!0;const v=a.width,E=a.height;for(let T=0;T<p.length;T++){const w=p[T];w.setSize&&w.setSize(v,E)}},this.begin=function(A,v){if(g||A.toneMapping===yn&&p.length===0)return!1;if(m=v,v!==null){const E=v.width,T=v.height;(a.width!==E||a.height!==T)&&this.setSize(E,T)}return S===!1&&A.setRenderTarget(a),M=A.toneMapping,A.toneMapping=yn,!0},this.hasRenderPass=function(){return S},this.end=function(A,v){A.toneMapping=M,g=!0;let E=a,T=o;for(let w=0;w<p.length;w++){const _=p[w];if(_.enabled!==!1&&(_.render(A,T,E,v),_.needsSwap!==!1)){const b=E;E=T,T=b}}if(u!==A.outputColorSpace||f!==A.toneMapping){u=A.outputColorSpace,f=A.toneMapping,l.defines={},He.getTransfer(u)===Je&&(l.defines.SRGB_TRANSFER="");const w=Gg[f];w&&(l.defines[w]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=E.texture,A.setRenderTarget(m),A.render(h,d),m=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}const Yh=new Ut,Lo=new Ji(1,1),Kh=new bh,Zh=new Ed,$h=new Lh,Rc=[],Cc=[],Pc=new Float32Array(16),Lc=new Float32Array(9),Nc=new Float32Array(4);function ls(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Rc[s];if(r===void 0&&(r=new Float32Array(s),Rc[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function St(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Et(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Kr(i,e){let t=Cc[e];t===void 0&&(t=new Int32Array(e),Cc[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Wg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Xg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2fv(this.addr,e),Et(t,e)}}function qg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(St(t,e))return;i.uniform3fv(this.addr,e),Et(t,e)}}function Yg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4fv(this.addr,e),Et(t,e)}}function Kg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Et(t,e)}else{if(St(t,n))return;Nc.set(n),i.uniformMatrix2fv(this.addr,!1,Nc),Et(t,n)}}function Zg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Et(t,e)}else{if(St(t,n))return;Lc.set(n),i.uniformMatrix3fv(this.addr,!1,Lc),Et(t,n)}}function $g(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Et(t,e)}else{if(St(t,n))return;Pc.set(n),i.uniformMatrix4fv(this.addr,!1,Pc),Et(t,n)}}function Jg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function jg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2iv(this.addr,e),Et(t,e)}}function Qg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3iv(this.addr,e),Et(t,e)}}function e_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4iv(this.addr,e),Et(t,e)}}function t_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function n_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2uiv(this.addr,e),Et(t,e)}}function i_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3uiv(this.addr,e),Et(t,e)}}function s_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4uiv(this.addr,e),Et(t,e)}}function r_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Lo.compareFunction=t.isReversedDepthBuffer()?Wo:Ho,r=Lo):r=Yh,t.setTexture2D(e||r,s)}function a_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Zh,s)}function o_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||$h,s)}function l_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Kh,s)}function c_(i){switch(i){case 5126:return Wg;case 35664:return Xg;case 35665:return qg;case 35666:return Yg;case 35674:return Kg;case 35675:return Zg;case 35676:return $g;case 5124:case 35670:return Jg;case 35667:case 35671:return jg;case 35668:case 35672:return Qg;case 35669:case 35673:return e_;case 5125:return t_;case 36294:return n_;case 36295:return i_;case 36296:return s_;case 35678:case 36198:case 36298:case 36306:case 35682:return r_;case 35679:case 36299:case 36307:return a_;case 35680:case 36300:case 36308:case 36293:return o_;case 36289:case 36303:case 36311:case 36292:return l_}}function h_(i,e){i.uniform1fv(this.addr,e)}function u_(i,e){const t=ls(e,this.size,2);i.uniform2fv(this.addr,t)}function d_(i,e){const t=ls(e,this.size,3);i.uniform3fv(this.addr,t)}function f_(i,e){const t=ls(e,this.size,4);i.uniform4fv(this.addr,t)}function p_(i,e){const t=ls(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function m_(i,e){const t=ls(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function g_(i,e){const t=ls(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function __(i,e){i.uniform1iv(this.addr,e)}function x_(i,e){i.uniform2iv(this.addr,e)}function v_(i,e){i.uniform3iv(this.addr,e)}function M_(i,e){i.uniform4iv(this.addr,e)}function y_(i,e){i.uniform1uiv(this.addr,e)}function b_(i,e){i.uniform2uiv(this.addr,e)}function S_(i,e){i.uniform3uiv(this.addr,e)}function E_(i,e){i.uniform4uiv(this.addr,e)}function T_(i,e,t){const n=this.cache,s=e.length,r=Kr(t,s);St(n,r)||(i.uniform1iv(this.addr,r),Et(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=Lo:a=Yh;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function A_(i,e,t){const n=this.cache,s=e.length,r=Kr(t,s);St(n,r)||(i.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Zh,r[a])}function w_(i,e,t){const n=this.cache,s=e.length,r=Kr(t,s);St(n,r)||(i.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||$h,r[a])}function R_(i,e,t){const n=this.cache,s=e.length,r=Kr(t,s);St(n,r)||(i.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Kh,r[a])}function C_(i){switch(i){case 5126:return h_;case 35664:return u_;case 35665:return d_;case 35666:return f_;case 35674:return p_;case 35675:return m_;case 35676:return g_;case 5124:case 35670:return __;case 35667:case 35671:return x_;case 35668:case 35672:return v_;case 35669:case 35673:return M_;case 5125:return y_;case 36294:return b_;case 36295:return S_;case 36296:return E_;case 35678:case 36198:case 36298:case 36306:case 35682:return T_;case 35679:case 36299:case 36307:return A_;case 35680:case 36300:case 36308:case 36293:return w_;case 36289:case 36303:case 36311:case 36292:return R_}}class P_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=c_(t.type)}}class L_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=C_(t.type)}}class N_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Ia=/(\w+)(\])?(\[|\.)?/g;function Ic(i,e){i.seq.push(e),i.map[e.id]=e}function I_(i,e,t){const n=i.name,s=n.length;for(Ia.lastIndex=0;;){const r=Ia.exec(n),a=Ia.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Ic(t,l===void 0?new P_(o,i,e):new L_(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new N_(o),Ic(t,d)),t=d}}}class Ar{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);I_(o,c,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Dc(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const D_=37297;let U_=0;function F_(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Uc=new Fe;function O_(i){He._getMatrix(Uc,He.workingColorSpace,i);const e=`mat3( ${Uc.elements.map(t=>t.toFixed(4))} )`;switch(He.getTransfer(i)){case Nr:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return Re("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Fc(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}const k_={[ah]:"Linear",[oh]:"Reinhard",[lh]:"Cineon",[ch]:"ACESFilmic",[uh]:"AgX",[dh]:"Neutral",[hh]:"Custom"};function z_(i,e){const t=k_[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const pr=new I;function V_(){He.getLuminanceCoefficients(pr);const i=pr.x.toFixed(4),e=pr.y.toFixed(4),t=pr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function G_(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(vs).join(`
`)}function H_(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function W_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function vs(i){return i!==""}function Oc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Bc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const X_=/^[ \t]*#include +<([\w\d./]+)>/gm;function No(i){return i.replace(X_,Y_)}const q_=new Map;function Y_(i,e){let t=ze[e];if(t===void 0){const n=q_.get(e);if(n!==void 0)t=ze[n],Re('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return No(t)}const K_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function kc(i){return i.replace(K_,Z_)}function Z_(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function zc(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const $_={[yr]:"SHADOWMAP_TYPE_PCF",[_s]:"SHADOWMAP_TYPE_VSM"};function J_(i){return $_[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const j_={[_i]:"ENVMAP_TYPE_CUBE",[Zi]:"ENVMAP_TYPE_CUBE",[Hr]:"ENVMAP_TYPE_CUBE_UV"};function Q_(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":j_[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const e0={[Zi]:"ENVMAP_MODE_REFRACTION"};function t0(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":e0[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const n0={[Gr]:"ENVMAP_BLENDING_MULTIPLY",[ku]:"ENVMAP_BLENDING_MIX",[zu]:"ENVMAP_BLENDING_ADD"};function i0(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":n0[i.combine]||"ENVMAP_BLENDING_NONE"}function s0(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function r0(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=J_(t),l=Q_(t),h=t0(t),d=i0(t),u=s0(t),f=G_(t),g=H_(r),M=s.createProgram();let m,p,S=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const A=S+m+a,v=S+p+o,E=Dc(s,s.VERTEX_SHADER,A),T=Dc(s,s.FRAGMENT_SHADER,v);s.attachShader(M,E),s.attachShader(M,T),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function w(R){if(i.debug.checkShaderErrors){const L=s.getProgramInfoLog(M)||"",V=s.getShaderInfoLog(E)||"",Y=s.getShaderInfoLog(T)||"",F=L.trim(),N=V.trim(),k=Y.trim();let q=!0,J=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,E,T);else{const ie=Fc(s,E,"vertex"),ne=Fc(s,T,"fragment");Ge("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
`;const ke=i=>document.querySelector(i),cx={l:2988957,m:13924166,r:8688794},Yi=ke("#arm-select"),jc=ke("#connection"),Qc=ke("#mode"),tu=ke("#stop-button"),nu=ke("#cancel-motion"),iu=ke("#movej"),su=ke("#start-velocity"),ru=ke("#cancel-velocity"),Oa=ke("#action-state"),hx=ke("#velocity-state"),eh=ke("#coordinate-state"),th=ke("#coordinate-summary"),Io=ke("#feedback"),wr=ke("#result"),ux=ke("#progress"),Ms=ke("#viewer-state"),nh=ke("#canvas"),kr=ke("#viewer"),ih=ke("#fleet-strip");let Tn,Ke="l",zt=[],Ds=[],Ht,Rr=!1,xn="",vn="",Dn=0;const tl={},nl={},es={},Us={},ts={};let Jn,Qn,Nn,zi,Ba=null,sh=0;function Fs(){if(!Tn)throw new Error("manifest not loaded");return Tn.robots.find(i=>i.id===Ke)}function il(i){if(!Tn)throw new Error("manifest not loaded");return Tn.robots.find(e=>e.id===i)}function sl(i){return`${i}-${Date.now()}-${Math.random().toString(16).slice(2,8)}`}function rl(){return!Rr&&(Ht==null?void 0:Ht.readyState)===WebSocket.OPEN}function ka(i){return i?`${i.type===1?"WORK":i.type===2?"TOOL":"BASE"} / ${i.name}`:"BASE / base"}function al(){return tl[Ke]}function zr(){return ts[Ke]}function $r(i){const e=il(i);return es[i]??e.joints.map(()=>Tn.default_joint_position_rad)}function ol(i){return Us[i]??$r(i)}function dx(){var i;Ds=[...$r(Ke)],zt=[...ol(Ke)],ou(zt,!0),(i=zr())!=null&&i.shadow&&is(zr().shadow,zt),ll(),hl(),Vi(),cl(),ii()}function ll(){var e,t,n,s,r;const i=al();if(eh.textContent=i?i.motion_allowed?"READY":"BLOCKED":"WAIT",eh.className=i?`mini-state ${i.motion_allowed?"accepted":"stopping"}`:"mini-state",!i){th.innerHTML='<div class="coordinate-empty">等待坐标状态</div>';return}th.innerHTML=`
    <div class="coordinate-row"><span>MOVE</span><strong>${ka(i.preferred_reference)}</strong></div>
    <div class="coordinate-row"><span>TOOL</span><strong>${ka(i.tool)}</strong></div>
    ...
    <div class="coordinate-row"><span>WORK</span><strong>${ka(i.work)}</strong></div>
  ...
  `}function Vi(){Tn&&(ih.innerHTML=Tn.robots.map(i=>{var c;const e=i.id,t=e===Ke,n=tl[e],s=nl[e],r=s===void 0?"WAIT":s?"ONLINE":"OFFLINE",a=n?n.motion_allowed?"READY":"BLOCKED":"WAIT",o=((c=es[e])==null?void 0:c.length)||0;return`
    ...
    `}).join(""),ih.querySelectorAll("button[data-arm]").forEach(i=>{i.addEventListener("click",()=>{const e=i.dataset.arm;Yi.value!==e&&(Yi.value=e,Yi.dispatchEvent(new Event("change")))})}))}function fx(){const i=al();return i!=null&&i.preferred_reference?i.preferred_reference:{type:0,name:"base",frame_id:`${Ke}/base_link`}}function ns(i){(Ht==null?void 0:Ht.readyState)===WebSocket.OPEN&&Ht.send(JSON.stringify(i))}function Do(i){jc.textContent=i?"ROS ONLINE":"OFFLINE",jc.classList.toggle("offline",!i)}function cl(){const i=!!nl[Ke];Do(i)}function au(){const i=ke("#joint-controls");i.innerHTML=Fs().joints.map((e,t)=>`
  ...
  `).join(""),i.querySelectorAll("input[data-joint-index]").forEach(e=>e.addEventListener("input",()=>{var n,s;const t=Number(e.dataset.jointIndex);zt[t]=Number(e.value)*Math.PI/180,Us[Ke]=[...zt],ke(`#joint-value-${t}`).textContent=`${Number(e.value).toFixed(1)}°`,(s=(n=zr())==null?void 0:n.shadow)==null||s.setJointValues(Object.fromEntries(zt.map((r,a)=>[`joint_${a+1}`,r])))}))}function ou(i,e=!1){i.forEach((t,n)=>{const s=ke(`input[data-joint-index="${n}"]`),r=ke(`#joint-value-${n}`);if(!s||!r)return;const a=t*180/Math.PI;e&&(zt[n]=t,s.value=String(a)),r.textContent=`${a.toFixed(1)}°`})}function is(i,e){i==null||i.setJointValues(Object.fromEntries(e.map((t,n)=>[`joint_${n+1}`,t])))}function rh(i,e,t){i==null||i.traverse(n=>{n instanceof bt&&(n.material=new pf({color:e?14715474:cx[t],metalness:e?.05:.25,roughness:.56,transparent:e,opacity:e?t===Ke?.28:0:1,depthWrite:!e}),n.castShadow=!e,n.receiveShadow=!e)})}function lu(i){var n,s;const e=Ba?(n=ts[Ba])==null?void 0:n.shadow:null;e==null||e.traverse(r=>{r instanceof bt&&"opacity"in r.material&&(r.material.opacity=0)});const t=(s=ts[i])==null?void 0:s.shadow;t==null||t.traverse(r=>{r instanceof bt&&"opacity"in r.material&&(r.material.opacity=.28)}),Ba=i}function Uo(i){let e=0;return i==null||i.traverse(t=>{t instanceof bt&&(e+=1)}),e}async function px(i,e=7){for(let t=0;t<160;t+=1){if(i.every(n=>Uo(n)>=e))return;await new Promise(n=>window.setTimeout(n,50))}throw new Error("URDF mesh loading timed out")}async function mx(){const i=++sh;Ms.textContent="加载 URDF…",Ms.removeAttribute("hidden");const e=new ox;e.packages={rm65_description:`${location.origin}/models`};try{const t=await Promise.all(Tn.robots.map(async u=>{const f=await e.loadAsync(`${location.origin}${u.urdf_url}`),g=await e.loadAsync(`${location.origin}${u.urdf_url}`);return{config:u,live:f,shadow:g}}));if(i!==sh)return;Qn.clear(),Qn.add(new Lf(15200493,2503736,2.5));const n=new Gh(16777215,4);n.position.set(2,-3,4),n.castShadow=!0,Qn.add(n);const s=new zf(3.5,22,5664888,2505536);s.rotation.x=Math.PI/2,Qn.add(s);const r=[];t.forEach(({config:u,live:f,shadow:g})=>{f.position.set(u.transform.x,u.transform.y,u.transform.z),f.rotation.set(u.transform.roll,u.transform.pitch,u.transform.yaw,"ZYX"),g.position.set(u.transform.x,u.transform.y,u.transform.z),g.rotation.set(u.transform.roll,u.transform.pitch,u.transform.yaw,"ZYX"),Qn.add(f),Qn.add(g),ts[u.id]={live:f,shadow:g},r.push(f,g)}),await px(r),t.forEach(({config:u,live:f,shadow:g})=>{rh(f,!1,u.id),rh(g,!0,u.id),is(f,$r(u.id)),is(g,ol(u.id)),f.updateMatrixWorld(!0)});const a=new Mi;t.forEach(({live:u})=>a.expandByObject(u));const o=a.getCenter(new I),c=a.getSize(new I),l=Math.max(c.x,c.y,c.z,.5),h=a.min.z+c.z*.46;zi.target.set(o.x,o.y,h),Nn.position.set(o.x+l*1.18,o.y-l*1.65,h+l*.82),Nn.lookAt(zi.target);const d=il(Ke);lu(Ke),kr.dataset.liveMeshes=String(t.reduce((u,{live:f})=>u+Uo(f),0)),kr.dataset.shadowMeshes=String(t.reduce((u,{shadow:f})=>u+Uo(f),0)),Ms.setAttribute("hidden",""),ke("#model-label").textContent=`${d.model} / ${Ke.toUpperCase()} + 3 arms`}catch(t){Ms.textContent=`URDF 加载失败: ${String(t)}`}}function gx(){Jn=new O0({canvas:nh,antialias:!0,alpha:!0,preserveDrawingBuffer:!0}),Jn.setPixelRatio(Math.min(window.devicePixelRatio,2)),Jn.outputColorSpace=ot,Jn.setClearColor(594196,1),Jn.shadowMap.enabled=!0,Qn=new Th,Nn=new Dt(35,1,.01,100),Nn.up.set(0,0,1),Nn.position.set(1.2,-1.8,1.25),zi=new k0(Nn,nh),zi.enableDamping=!0,zi.target.set(0,0,.55);const i=()=>{const t=kr.getBoundingClientRect();!t.width||!t.height||(Jn.setSize(t.width,t.height,!1),Nn.aspect=t.width/t.height,Nn.updateProjectionMatrix())};new ResizeObserver(i).observe(kr),i();const e=()=>{requestAnimationFrame(e),zi.update(),Jn.render(Qn,Nn)};e()}function hl(){const i=Fs().motion;ke("#velocity-frame").innerHTML=Object.entries(Fs().frames).map(([n,s])=>`<option value="${n}">${n.toUpperCase()} / ${s.name}</option>`).join(""),ke("#velocity-period").setAttribute("value",String(i.velocity_control_period_ms)),ke("#velocity-watchdog").setAttribute("value",String(i.velocity_watchdog_ms)),ke("#linear-accel").setAttribute("value",String(i.max_linear_accel_mps2)),ke("#angular-accel").setAttribute("value",String(i.max_angular_accel_radps2));const e=["vx","vy","vz","wx","wy","wz"];ke("#velocity-inputs").innerHTML=e.map((n,s)=>`<label>${n}<input id="velocity-${s}" type="number" step="0.01" value="0" /></label>`).join("");const t=al();if(t!=null&&t.preferred_reference){const n=t.preferred_reference.type===1?"work":t.preferred_reference.type===2?"tool":"base";ke("#velocity-frame").value=n}}function _x(i){var e,t;if(i.type==="hello")Rr=!!i.read_only,Qc.textContent=Rr?"READ ONLY":"CONTROL READY",Qc.classList.toggle("ready",!Rr),i.layout&&hu(i.layout);else if(i.type==="coordinate_state")tl[i.arm]=i,Vi(),i.arm===Ke&&(ll(),Tn&&hl());else if(i.type==="connection")nl[i.arm]=!!i.connected,Vi(),i.arm===Ke&&cl();else if(i.type==="joint_state")es[i.arm]=i.positions_rad,is((e=ts[i.arm])==null?void 0:e.live,i.positions_rad),i.arm===Ke&&(Ds=i.positions_rad,ke("#joint-stamp").textContent=`joint_states / ${i.stamp_ns||0}`),Vi();else if(i.type==="action_state"){if(i.arm!==Ke){Vi();return}Oa.textContent=String(i.state).toUpperCase(),Oa.className=`mini-state ${i.state}`,i.action==="cartesian_velocity"&&(hx.textContent=String(i.state).toUpperCase()),["rejected","error"].includes(i.state)&&(i.action==="execute_motion"&&(xn=""),i.action==="cartesian_velocity"&&(vn="",window.clearInterval(Dn),Dn=0),ii())}else if(i.type==="action_feedback"){if(i.arm!==Ke)return;const n=i.feedback||{};if(Io.textContent=`${i.action} / ${n.detail||"executing"} / progress ${n.progress??"-"}`,Array.isArray(n.current_joint_degrees)){const s=n.current_joint_degrees.map(r=>r*Math.PI/180);es[i.arm]=s,Ds=s,is((t=ts[i.arm])==null?void 0:t.live,s)}Array.isArray(n.commanded_linear_velocity_mps)&&(Io.textContent=`velocity / ${n.commanded_linear_velocity_mps.map(s=>s.toFixed(3)).join(", ")}`),ux.style.width=`${Math.max(0,Math.min(100,Number(n.progress||0)*100))}%`}else if(i.type==="action_result"){if(i.arm!==Ke)return;wr.textContent=JSON.stringify(i.result,null,2),Oa.textContent="RESULT",xn=i.action==="execute_motion"?"":xn,vn=i.action==="cartesian_velocity"?"":vn,ii()}else i.type==="software_stop_result"?wr.textContent=`软件停止: ${i.success?"成功":"失败"} / ${i.message}`:i.type==="error"&&(wr.textContent=`${i.code}: ${i.message}`,i.request_id===xn&&(xn=""),i.request_id===vn&&(vn="",window.clearInterval(Dn),Dn=0),ii())}function cu(){Ht==null||Ht.close();const i=location.protocol==="https:"?"wss":"ws";Ht=new WebSocket(`${i}://${location.host}/ws`),Ht.addEventListener("open",()=>Do(!0)),Ht.addEventListener("close",()=>{Do(!1),ii(),window.setTimeout(cu,2e3)}),Ht.addEventListener("message",e=>{try{_x(JSON.parse(e.data))}catch{wr.textContent="收到无法解析的服务器消息"}})}function ii(){const i=rl();iu.disabled=!i||!!xn,su.disabled=!i||!!vn,ru.disabled=!i||!vn,nu.disabled=!i||!xn,tu.disabled=!i}function hu(i){Tn=i,Ke=Yi.value,i.robots.forEach(e=>{const t=e.joints.map(()=>i.default_joint_position_rad);es[e.id]=es[e.id]??[...t],Us[e.id]=Us[e.id]??[...t]}),Ds=[...$r(Ke)],zt=[...ol(Ke)],ke("#root-frame").textContent=`TF / ${i.root_frame}`,au(),hl(),ll(),Vi(),cl(),Jn||gx(),mx(),ii()}ke("#reset-preview").addEventListener("click",()=>{var i;zt=[...Ds],Us[Ke]=[...zt],ou(zt,!0),is((i=zr())==null?void 0:i.shadow,zt)});Yi.addEventListener("change",()=>{Ke=Yi.value,xn="",vn="",window.clearInterval(Dn),Dn=0,au(),lu(Ke),dx();const i=il(Ke);ke("#model-label").textContent=`${i.model} / ${Ke.toUpperCase()} + 3 arms`});iu.addEventListener("click",()=>{if(!rl())return;xn=sl("movej");const i=fx();ns({type:"execute_motion",request_id:xn,arm:Ke,goal:{command:0,reference_type:i.type,reference_name:i.name,joint_degrees:zt.map(e=>e*180/Math.PI),pose_position_m:[0,0,0],pose_quaternion_wxyz:[1,0,0,0],velocity_percent:30,blend_radius_percent:0,timeout_sec:Fs().motion.default_timeout_sec}}),Io.textContent="MOVEJ 已发送，等待 feedback…",ii()});su.addEventListener("click",()=>{if(!rl())return;const i=Fs().frames[ke("#velocity-frame").value];vn=sl("velocity"),ns({type:"start_cartesian_velocity",request_id:vn,arm:Ke,goal:{reference_type:i.type,reference_name:i.name,control_period_ms:Number(ke("#velocity-period").value),watchdog_ms:Number(ke("#velocity-watchdog").value),max_linear_accel_mps2:Number(ke("#linear-accel").value),max_angular_accel_radps2:Number(ke("#angular-accel").value),follow:!1,trajectory_mode:0,radio:0}}),ii(),Dn=window.setInterval(()=>{const e=Array.from({length:6},(t,n)=>Number(ke(`#velocity-${n}`).value));ns({type:"velocity_command",arm:Ke,linear:e.slice(0,3),angular:e.slice(3)})},20)});ru.addEventListener("click",()=>{ns({type:"cancel_action",arm:Ke,action:"cartesian_velocity"}),window.clearInterval(Dn),Dn=0});nu.addEventListener("click",()=>{ns({type:"cancel_action",arm:Ke,action:"execute_motion"})});tu.addEventListener("click",()=>{ns({type:"software_stop",request_id:sl("stop"),arm:Ke})});fetch("/api/layout").then(i=>i.json()).then(hu).catch(i=>{Ms.textContent=`布局加载失败: ${String(i)}`});cu();
