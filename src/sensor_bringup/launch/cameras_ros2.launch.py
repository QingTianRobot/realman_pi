...
def generate_launch_description():
    ...
    declarations = [
        ...
        DeclareLaunchArgument(
            "left_delay",
            default_value="0.0",
            description="Seconds before starting the left Orbbec camera (0 = parallel).",
        ),
        DeclareLaunchArgument(
            "middle_delay",
            default_value="8.0",
            description="Seconds before starting the middle Orbbec camera.",
        ),
        DeclareLaunchArgument(
            "right_delay",
            default_value="16.0",
            description="Seconds before starting the right Orbbec camera.",
        ),
    ...
    camera_actions = [
        _camera_include(
            ...
            LaunchConfiguration("left_delay"),
        ),
        _camera_include(
            "middle",
            ...
            LaunchConfiguration("middle_delay"),
        ),
        _camera_include(
            "right",
            ...
            LaunchConfiguration("right_delay"),
        ),
