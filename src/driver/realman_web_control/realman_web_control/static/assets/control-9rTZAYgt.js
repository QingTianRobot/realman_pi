...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qn,depthTest:!1,depthWrite:!1})}function I_(i,e,t){const n=new Float32Array(Ui),s=new I(0,1,0);return new Fn({name:"SphericalGaussianBlur",defines:{n:Ui,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:qn,depthTest:!1,depthWrite:!1})}function mu(){return new Fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:qn,depthTest:!1,depthWrite:!1})}function gu(){return new Fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Aa(),fragmentShader:`
	...
	`}class Uh extends In{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new yh(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Ts(5,5,5),r=new Fn({name:"CubemapFromEquirect",uniforms:bs(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Yt,blending:qn});r.uniforms.tEquirect.value=t;const a=new Tt(s,r),o=t.minFilter;return t.minFilter===Wn&&(t.minFilter=Et),new Op(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function D_(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,f=!1){return h==null?null:f?a(h):r(h)}function r(h){if(h&&h.isTexture){const f=h.mapping;if(f===Oa||f===Ba)if(e.has(h)){const g=e.get(h).texture;return o(g,h.mapping)}else{const g=h.image;if(g&&g.height>0){const y=new Uh(g.height);return y.fromEquirectangularTexture(i,h),e.set(h,y),h.addEventListener("dispose",l),o(y.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const f=h.mapping,g=f===Oa||f===Ba,y=f===zi||f===xs;if(g||y){let m=t.get(h);const p=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==p)return n===null&&(n=new fu(i)),m=g?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{const S=h.image;return g&&S&&S.height>0||y&&S&&c(S)?(n===null&&(n=new fu(i)),m=g?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function o(h,f){return f===Oa?h.mapping=zi:f===Ba&&(h.mapping=xs),h}function c(h){let f=0;const g=6;for(let y=0;y<g;y++)h[y]!==void 0&&f++;return f===g}function l(h){const f=h.target;f.removeEventListener("dispose",l);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function u(h){const f=h.target;f.removeEventListener("dispose",u);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function d(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:d}}function U_(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&ps("WebGLRenderer: "+n+" extension not supported."),s}}}function F_(i,e,t,n){const s={},r=new WeakMap;function a(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);h.removeEventListener("dispose",a),delete s[h.id];const f=r.get(h);f&&(e.remove(f),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(d,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function c(d){const h=d.attributes;for(const f in h)e.update(h[f],i.ARRAY_BUFFER)}function l(d){const h=[],f=d.index,g=d.attributes.position;let y=0;if(g===void 0)return;if(f!==null){const S=f.array;y=f.version;for(let A=0,v=S.length;A<v;A+=3){const T=S[A+0],E=S[A+1],w=S[A+2];h.push(T,E,E,w,w,T)}}else{const S=g.array;y=g.version;for(let A=0,v=S.length/3-1;A<v;A+=3){const T=A+0,E=A+1,w=A+2;h.push(T,E,E,w,w,T)}}const m=new(g.count>=65535?gh:mh)(h,1);m.version=y;const p=r.get(d);p&&e.remove(p),r.set(d,m)}function u(d){const h=r.get(d);if(h){const f=d.index;f!==null&&h.version<f.version&&l(d)}else l(d);return r.get(d)}return{get:o,update:c,getWireframeAttribute:u}}function O_(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function c(d,h){i.drawElements(n,h,r,d*a),t.update(h,n,1)}function l(d,h,f){f!==0&&(i.drawElementsInstanced(n,h,r,d*a,f),t.update(h,n,f))}function u(d,h,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,d,0,f);let y=0;for(let m=0;m<f;m++)y+=h[m];t.update(y,n,1)}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u}function B_(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:He("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function k_(i,e,t){const n=new WeakMap,s=new nt;function r(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==d){let b=function(){w.dispose(),n.delete(o),o.removeEventListener("dispose",b)};h!==void 0&&h.texture.dispose();const f=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,y=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],S=o.morphAttributes.color||[];let A=0;f===!0&&(A=1),g===!0&&(A=2),y===!0&&(A=3);let v=o.attributes.position.count*A,T=1;v>e.maxTextureSize&&(T=Math.ceil(v/e.maxTextureSize),v=e.maxTextureSize);const E=new Float32Array(v*T*4*d),w=new hh(E,v,T,d);w.type=gn,w.needsUpdate=!0;const _=A*4;for(let P=0;P<d;P++){const R=m[P],L=p[P],z=S[P],X=v*T*4*P;for(let O=0;O<R.count;O++){const N=O*_;f===!0&&(s.fromBufferAttribute(R,O),E[X+N+0]=s.x,E[X+N+1]=s.y,E[X+N+2]=s.z,E[X+N+3]=0),g===!0&&(s.fromBufferAttribute(L,O),E[X+N+4]=s.x,E[X+N+5]=s.y,E[X+N+6]=s.z,E[X+N+7]=0),y===!0&&(s.fromBufferAttribute(z,O),E[X+N+8]=s.x,E[X+N+9]=s.y,E[X+N+10]=s.z,E[X+N+11]=z.itemSize===4?s.w:1)}}h={count:d,texture:w,size:new Ne(v,T)},n.set(o,h),o.addEventListener("dispose",b)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let f=0;for(let y=0;y<l.length;y++)f+=l[y];const g=o.morphTargetsRelative?1:1-f;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function z_(i,e,t,n,s){let r=new WeakMap;function a(l){const u=s.render.frame,d=l.geometry,h=e.get(l,d);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),r.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==u&&(f.update(),r.set(f,u))}return h}function o(){r=new WeakMap}function c(l){const u=l.target;u.removeEventListener("dispose",c),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const V_={[Ku]:"LINEAR_TONE_MAPPING",[Zu]:"REINHARD_TONE_MAPPING",[Ju]:"CINEON_TONE_MAPPING",[ju]:"ACES_FILMIC_TONE_MAPPING",[eh]:"AGX_TONE_MAPPING",[th]:"NEUTRAL_TONE_MAPPING",[Qu]:"CUSTOM_TONE_MAPPING"};function G_(i,e,t,n,s,r){const a=new In(e,t,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,depthTexture:s?new ys(e,t):void 0}),o=new In(e,t,{type:Zn,depthBuffer:!1,stencilBuffer:!1}),c=new zt;c.setAttribute("position",new tt([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new tt([0,2,0,0,2,0],2));const l=new dp({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new Tt(c,l),d=new Ta(-1,1,1,-1,0,1);let h=null,f=null,g=!1,y,m=null,p=[],S=!1;this.setSize=function(A,v){a.setSize(A,v),o.setSize(A,v);for(let T=0;T<p.length;T++){const E=p[T];E.setSize&&E.setSize(A,v)}},this.setEffects=function(A){p=A,S=p.length>0&&p[0].isRenderPass===!0;const v=a.width,T=a.height;for(let E=0;E<p.length;E++){const w=p[E];w.setSize&&w.setSize(v,T)}},this.begin=function(A,v){if(g||A.toneMapping===Nn&&p.length===0)return!1;if(m=v,v!==null){const T=v.width,E=v.height;(a.width!==T||a.height!==E)&&this.setSize(T,E)}return S===!1&&A.setRenderTarget(a),y=A.toneMapping,A.toneMapping=Nn,!0},this.hasRenderPass=function(){return S},this.end=function(A,v){A.toneMapping=y,g=!0;let T=a,E=o;for(let w=0;w<p.length;w++){const _=p[w];if(_.enabled!==!1&&(_.render(A,E,T,v),_.needsSwap!==!1)){const b=T;T=E,E=b}}if(h!==A.outputColorSpace||f!==A.toneMapping){h=A.outputColorSpace,f=A.toneMapping,l.defines={},We.getTransfer(h)===Je&&(l.defines.SRGB_TRANSFER="");const w=V_[f];w&&(l.defines[w]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=T.texture,A.setRenderTarget(m),A.render(u,d),m=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}const Fh=new kt,pl=new ys(1,1),Oh=new hh,Bh=new Ef,kh=new yh,_u=[],xu=[],vu=new Float32Array(16),yu=new Float32Array(9),Mu=new Float32Array(4);function Rs(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=_u[s];if(r===void 0&&(r=new Float32Array(s),_u[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function At(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function wt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function wa(i,e){let t=xu[e];t===void 0&&(t=new Int32Array(e),xu[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function H_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function W_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(At(t,e))return;i.uniform2fv(this.addr,e),wt(t,e)}}function X_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(At(t,e))return;i.uniform3fv(this.addr,e),wt(t,e)}}function q_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(At(t,e))return;i.uniform4fv(this.addr,e),wt(t,e)}}function Y_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(At(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),wt(t,e)}else{if(At(t,n))return;Mu.set(n),i.uniformMatrix2fv(this.addr,!1,Mu),wt(t,n)}}function $_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(At(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),wt(t,e)}else{if(At(t,n))return;yu.set(n),i.uniformMatrix3fv(this.addr,!1,yu),wt(t,n)}}function K_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(At(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),wt(t,e)}else{if(At(t,n))return;vu.set(n),i.uniformMatrix4fv(this.addr,!1,vu),wt(t,n)}}function Z_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function J_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(At(t,e))return;i.uniform2iv(this.addr,e),wt(t,e)}}function j_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(At(t,e))return;i.uniform3iv(this.addr,e),wt(t,e)}}function Q_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(At(t,e))return;i.uniform4iv(this.addr,e),wt(t,e)}}function e0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function t0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(At(t,e))return;i.uniform2uiv(this.addr,e),wt(t,e)}}function n0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(At(t,e))return;i.uniform3uiv(this.addr,e),wt(t,e)}}function i0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(At(t,e))return;i.uniform4uiv(this.addr,e),wt(t,e)}}function s0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(pl.compareFunction=t.isReversedDepthBuffer()?Rl:wl,r=pl):r=Fh,t.setTexture2D(e||r,s)}function r0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Bh,s)}function a0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||kh,s)}function o0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Oh,s)}function l0(i){switch(i){case 5126:return H_;case 35664:return W_;case 35665:return X_;case 35666:return q_;case 35674:return Y_;case 35675:return $_;case 35676:return K_;case 5124:case 35670:return Z_;case 35667:case 35671:return J_;case 35668:case 35672:return j_;case 35669:case 35673:return Q_;case 5125:return e0;case 36294:return t0;case 36295:return n0;case 36296:return i0;case 35678:case 36198:case 36298:case 36306:case 35682:return s0;case 35679:case 36299:case 36307:return r0;case 35680:case 36300:case 36308:case 36293:return a0;case 36289:case 36303:case 36311:case 36292:return o0}}function c0(i,e){i.uniform1fv(this.addr,e)}function u0(i,e){const t=Rs(e,this.size,2);i.uniform2fv(this.addr,t)}function h0(i,e){const t=Rs(e,this.size,3);i.uniform3fv(this.addr,t)}function d0(i,e){const t=Rs(e,this.size,4);i.uniform4fv(this.addr,t)}function f0(i,e){const t=Rs(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function p0(i,e){const t=Rs(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function m0(i,e){const t=Rs(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function g0(i,e){i.uniform1iv(this.addr,e)}function _0(i,e){i.uniform2iv(this.addr,e)}function x0(i,e){i.uniform3iv(this.addr,e)}function v0(i,e){i.uniform4iv(this.addr,e)}function y0(i,e){i.uniform1uiv(this.addr,e)}function M0(i,e){i.uniform2uiv(this.addr,e)}function b0(i,e){i.uniform3uiv(this.addr,e)}function S0(i,e){i.uniform4uiv(this.addr,e)}function E0(i,e,t){const n=this.cache,s=e.length,r=wa(t,s);At(n,r)||(i.uniform1iv(this.addr,r),wt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=pl:a=Fh;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function T0(i,e,t){const n=this.cache,s=e.length,r=wa(t,s);At(n,r)||(i.uniform1iv(this.addr,r),wt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Bh,r[a])}function A0(i,e,t){const n=this.cache,s=e.length,r=wa(t,s);At(n,r)||(i.uniform1iv(this.addr,r),wt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||kh,r[a])}function w0(i,e,t){const n=this.cache,s=e.length,r=wa(t,s);At(n,r)||(i.uniform1iv(this.addr,r),wt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Oh,r[a])}function R0(i){switch(i){case 5126:return c0;case 35664:return u0;case 35665:return h0;case 35666:return d0;case 35674:return f0;case 35675:return p0;case 35676:return m0;case 5124:case 35670:return g0;case 35667:case 35671:return _0;case 35668:case 35672:return x0;case 35669:case 35673:return v0;case 5125:return y0;case 36294:return M0;case 36295:return b0;case 36296:return S0;case 35678:case 36198:case 36298:case 36306:case 35682:return E0;case 35679:case 36299:case 36307:return T0;case 35680:case 36300:case 36308:case 36293:return A0;case 36289:case 36303:case 36311:case 36292:return w0}}class C0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=l0(t.type)}}class P0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=R0(t.type)}}class L0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const xo=/(\w+)(\])?(\[|\.)?/g;function bu(i,e){i.seq.push(e),i.map[e.id]=e}function N0(i,e,t){const n=i.name,s=n.length;for(xo.lastIndex=0;;){const r=xo.exec(n),a=xo.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){bu(t,l===void 0?new C0(o,i,e):new P0(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new L0(o),bu(t,d)),t=d}}}class jr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);N0(o,c,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Su(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const I0=37297;let D0=0;function U0(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Eu=new Be;function F0(i){We._getMatrix(Eu,We.workingColorSpace,i);const e=`mat3( ${Eu.elements.map(t=>t.toFixed(4))} )`;switch(We.getTransfer(i)){case ra:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return Pe("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Tu(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+U0(i.getShaderSource(e),o)}else return r}function O0(i,e){const t=F0(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const B0={[Ku]:"Linear",[Zu]:"Reinhard",[Ju]:"Cineon",[ju]:"ACESFilmic",[eh]:"AgX",[th]:"Neutral",[Qu]:"Custom"};function k0(i,e){const t=B0[e];return t===void 0?(Pe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const kr=new I;function z0(){We.getLuminanceCoefficients(kr);const i=kr.x.toFixed(4),e=kr.y.toFixed(4),t=kr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const K0={[Yr]:"SHADOWMAP_TYPE_PCF",[Os]:"SHADOWMAP_TYPE_VSM"};function Z0(i){return K0[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const J0={[zi]:"ENVMAP_TYPE_CUBE",[xs]:"ENVMAP_TYPE_CUBE",[ba]:"ENVMAP_TYPE_CUBE_UV"};function j0(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":J0[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Q0={[xs]:"ENVMAP_MODE_REFRACTION"};function ex(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Q0[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const tx={[Ma]:"ENVMAP_BLENDING_MULTIPLY",[Bd]:"ENVMAP_BLENDING_MIX",[kd]:"ENVMAP_BLENDING_ADD"};function nx(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":tx[i.combine]||"ENVMAP_BLENDING_NONE"}function ix(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function sx(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Z0(t),l=j0(t),u=ex(t),d=nx(t),h=ix(t),f=V0(t),g=G0(r),y=s.createProgram();let m,p,S=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const A=S+m+a,v=S+p+o,T=Su(s,s.VERTEX_SHADER,A),E=Su(s,s.FRAGMENT_SHADER,v);s.attachShader(y,T),s.attachShader(y,E),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function w(R){if(i.debug.checkShaderErrors){const L=s.getProgramInfoLog(y)||"",z=s.getShaderInfoLog(T)||"",X=s.getShaderInfoLog(E)||"",O=L.trim(),N=z.trim(),V=X.trim();let Y=!0,J=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,T,E);else{const se=Tu(s,T,"vertex"),ie=Tu(s,E,"fragment");He("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
`;const be=i=>document.querySelector(i),lv={l:2988957,m:13924166,r:8688794},sr=be("#arm-select"),Vu=be("#connection"),Gu=be("#mode"),Wh=be("#stop-button"),Xh=be("#cancel-motion"),qh=be("#recover-motion"),kl=be("#execute-motion"),Yh=be("#start-velocity"),$h=be("#cancel-velocity"),qr=be("#action-state"),cv=be("#velocity-state"),Hu=be("#coordinate-state"),Wu=be("#coordinate-summary"),gl=be("#feedback"),fi=be("#result"),uv=be("#progress"),zs=be("#viewer-state"),Xu=be("#canvas"),Xs=be("#viewer"),bo=be("#fleet-strip"),ha=be("#selected-arm-label"),Kh=be("#motion-mode"),hv=be("#joint-target"),dv=be("#pose-target"),qs=be("#pose-reference-frame"),Qr=be("#pose-sliders"),fv=be("#pose-kinematics-actions"),Zh=be("#fill-current-pose"),zl=be("#solve-ik"),Vl=be("#kinematics-status"),Jh=be("#reset-preview"),da=be("#motion-reference"),fa=be("#motion-velocity"),pa=be("#motion-timeout"),Ca=be("#record-name"),jh=be("#save-record"),on=be("#record-select"),Qh=be("#apply-record"),Gl=be("#delete-record"),ed=be("#record-status"),pv=["pose-x","pose-y","pose-z","pose-qw","pose-qx","pose-qy","pose-qz"],Hl={0:"MOVEJ",1:"MOVEL",2:"MOVEP"},mv={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};let xt,ne="l",ft=0,It=[],Pa=[],qt,ea=!1,wn="",Rn="",Xn=0;const La={},Wl={},Ss={},bi={},rr={},Si={},Bi={},_l={},ar={},Xl={},xi={},ki={},ma={},vi={},ql={},pn={},mi={},Ei={};let hi,Hn,Sn,yi,So=null,qu=0;function ga(){if(!xt)throw new Error("manifest not loaded");return xt.robots.find(i=>i.id===ne)}function Na(i){if(!xt)throw new Error("manifest not loaded");return xt.robots.find(e=>e.id===i)}function jn(i){return`${i}-${Date.now()}-${Math.random().toString(16).slice(2,8)}`}function Qn(){return!ea&&(qt==null?void 0:qt.readyState)===WebSocket.OPEN}function Mi(i,e=2){return Number.isFinite(i)?i.toFixed(e):""}function Ln(i,e=2){const t=Number(i);return Number.isFinite(t)?t.toFixed(e):String(i??"")}function ln(i){return i?`${i.type===1?"WORK":i.type===2?"TOOL":i.type===3?"TF":"BASE"} / ${i.name}`:"BASE / base"}function _a(i){return i.replace(/[&<>"']/g,e=>mv[e]??e)}function Ia(){return La[ne]}function xa(){return Ei[ne]}function cr(i){const e=Na(i);return Ss[i]??e.joints.map(()=>xt.default_joint_position_rad)}function Yl(i){return bi[i]??cr(i)}function td(i=ft){return i===1?"位姿已修改：影子等待“计算逆解”成功后更新":i===2?"MOVEP 位姿目标已修改：MOVEP 不提供逆解/影子预览，影子不会跟随滑轨；可直接发送 MOVEP":"位姿已修改"}function gv(){var i;Pa=[...cr(ne)],It=[...Yl(ne)],Da(It,!0),ad(),(i=xa())!=null&&i.shadow&&Wi(xa().shadow,It),ha.textContent=ne.toUpperCase(),ha.className="mini-state active-arm",$l(),Vl.textContent=Xl[ne]??"MOVEL 逆解仅更新影子预览",Ql(),hs(),Jl(),Qe()}function $l(){var e,t,n,s,r;const i=Ia();if(da.textContent=ln(i==null?void 0:i.preferred_reference),Hu.textContent=i?i.motion_allowed?"READY":"BLOCKED":"WAIT",Hu.className=i?`mini-state ${i.motion_allowed?"accepted":"stopping"}`:"mini-state",!i){Wu.innerHTML='<div class="coordinate-empty">等待坐标状态</div>';return}Wu.innerHTML=`
  ...
  `}function hs(){var e;if(!xt)return;const i=new Set(xt.robots.map(t=>t.id));for(const t of xt.robots){const n=t.id,s=n===ne,r=La[n],a=Wl[n],o=a===void 0?"WAIT":a?"ONLINE":"OFFLINE",c=r?r.motion_allowed?"READY":"BLOCKED":"WAIT",l=((e=Ss[n])==null?void 0:e.length)||0;let u=bo.querySelector(`button[data-arm="${n}"]`);u||(u=document.createElement("button"),u.type="button",u.className="fleet-chip",u.dataset.arm=n,u.innerHTML=`
      ...
      `,u.addEventListener("click",d=>{const h=d.currentTarget;sr.value=h.dataset.arm,sr.dispatchEvent(new Event("change"))}),bo.append(u)),u.classList.toggle("selected",s),u.querySelector(".fleet-chip-state").textContent=o,u.querySelector(".fleet-chip-motion").textContent=c,u.querySelector(".fleet-chip-meta").textContent=l?`${l} joints`:t.model}bo.querySelectorAll("button[data-arm]").forEach(t=>{i.has(t.dataset.arm)||t.remove()})}function nd(){const i=Ia();return i!=null&&i.preferred_reference?i.preferred_reference:{type:0,name:"base",frame_id:`${ne}/base_link`}}function Dn(i=ne){if(Bi[i])return Bi[i];const e=La[i];return e!=null&&e.preferred_reference?e.preferred_reference:{type:0,name:"base",frame_id:`${i}/base_link`}}function _v(i){const e=Na(i).frames;return Object.values(e).map(t=>({type:t.type,name:t.name,frame_id:t.frame_id}))}function id(i){const e=_v(i),t=new Set(e.map(s=>s.frame_id)),n=(_l[i]??[]).filter(s=>!t.has(s.frame_id));return[...e,...n]}function Kl(){const i=id(ne),e=Dn(ne);qs.innerHTML=i.map(n=>`<option value="${_a(n.frame_id??n.name)}">${_a(ln(n))}</option>`).join("");const t=e.frame_id??e.name;i.some(n=>(n.frame_id??n.name)===t)?qs.value=t:i[0]&&(qs.value=i[0].frame_id??i[0].name,Bi[ne]=i[0])}function xv(){var n;const i=((n=Si[ne])==null?void 0:n.slice(0,3).map(Number))??[];if(i.length!==3||!i.every(Number.isFinite)){Qr.innerHTML="";return}const e=ar[ne]??i;ar[ne]=[...e];const t=["X","Y","Z"];Qr.innerHTML=t.map((s,r)=>{const a=e[r],o=a-.2,c=a+.2;return`<label>${s}<input data-pose-slider-index="${r}" type="range" min="${o.toFixed(2)}" max="${c.toFixed(2)}" step="0.001" value="${Mi(i[r])}" /></label>`}).join(""),Qr.querySelectorAll("input[data-pose-slider-index]").forEach(s=>{s.addEventListener("input",()=>{const r=Number(s.dataset.poseSliderIndex),a=Hi()[r];a.value=s.value,Si[ne]=Hi().map(o=>o.value),ki[ne]=!1,An(ne,td()),$n(ne),Qe()})})}function vv(){Qr.querySelectorAll("input[data-pose-slider-index]").forEach(i=>{const e=Number(Hi()[Number(i.dataset.poseSliderIndex)].value);Number.isFinite(e)&&(i.value=String(e))})}function Hi(){return pv.map(i=>be(`#${i}`))}function ta(){const i=Si[ne]??["","","","1","0","0","0"];Hi().forEach((e,t)=>{const n=i[t]??"";e.value=n===""?"":Ln(n)}),Kl(),xv()}function va(){const i=Hi().map(n=>n.value.trim());if(i.some(n=>n===""))return null;const e=i.map(Number);if(!e.every(Number.isFinite))return null;const t=e.slice(3);return Math.hypot(...t)<1e-9?null:{position:e.slice(0,3),quaternion:t}}function sd(){const i=Number(fa.value),e=Number(pa.value);return!Number.isInteger(i)||i<1||i>100||!Number.isFinite(e)||e<=0?null:{velocity:i,timeout:e}}function rd(i){const e=ft;ft=i,Kh.querySelectorAll("button[data-motion-command]").forEach(t=>{const n=Number(t.dataset.motionCommand)===i;t.classList.toggle("selected",n),t.setAttribute("aria-pressed",String(n))}),hv.hidden=i!==0,dv.hidden=i===0,Jh.hidden=i!==0,fv.hidden=i===0,zl.hidden=i!==1,Gl.hidden=i!==0,kl.textContent=`发送 ${Hl[i]}`,$n(ne),i!==0&&(e===0||e!==i)&&Zl(ne),Qe()}function ad(){var e;ta(),Ys();const i=ma[ne];i&&(fa.value=Ln(i.velocity),pa.value=Ln(i.timeout)),da.textContent=ln((e=Ia())==null?void 0:e.preferred_reference),ft!==0&&(Kl(),da.textContent=ln(Dn())),Vl.textContent=Xl[ne]??"MOVEL 逆解仅更新影子预览",rd(ft)}function Zl(i,e=!1){if(!Qn()||!e&&xi[i])return;const t=jn("current-pose"),n=Dn(i);xi[i]=t,An(i,`读取 ${ln(n)} 当前位姿…`),un({type:"get_current_pose",request_id:t,arm:i,reference:{reference_type:n.type,reference_name:n.name}}),Qe()}function un(i){(qt==null?void 0:qt.readyState)===WebSocket.OPEN&&qt.send(JSON.stringify(i))}document.querySelectorAll('input[type="number"]').forEach(i=>{i.addEventListener("blur",()=>{i.value.trim()!==""&&(i.value=Ln(i.value))})});function Ys(){const i=vi[ne]??[],e=on.value;on.innerHTML=i.length?i.map(t=>`<option value="${_a(t.id)}">${_a(t.label)}</option>`).join(""):'<option value="">无记录</option>',i.some(t=>t.id===e)&&(on.value=e),ed.textContent=ql[ne]??(i.length?`${i.length} 条记录`:"无记录")}function An(i,e){Xl[i]=e,i===ne&&(Vl.textContent=e)}function Cn(i,e){ql[i]=e,i===ne&&(ed.textContent=e)}function xl(i){Vu.textContent=i?"ROS ONLINE":"OFFLINE",Vu.classList.toggle("offline",!i)}function Jl(){const i=!!Wl[ne];xl(i)}function od(){const i=be("#joint-controls");i.innerHTML=ga().joints.map((e,t)=>`
    <label class="joint-row"><span>J${t+1}<output id="joint-value-${t}">${Mi(It[t]*180/Math.PI)}°</output></span>
    <input data-joint-index="${t}" type="range" min="${e.lower_deg}" max="${e.upper_deg}" step="0.1" value="${It[t]*180/Math.PI}" /></label>
  `).join(""),i.querySelectorAll("input[data-joint-index]").forEach(e=>e.addEventListener("input",()=>{var n,s;const t=Number(e.dataset.jointIndex);It[t]=Number(e.value)*Math.PI/180,bi[ne]=[...It],rr[ne]=!0,be(`#joint-value-${t}`).textContent=`${Mi(Number(e.value))}°`,(s=(n=xa())==null?void 0:n.shadow)==null||s.setJointValues(Object.fromEntries(It.map((r,a)=>[`joint_${a+1}`,r])))}))}function Da(i,e=!1){i.forEach((t,n)=>{const s=be(`input[data-joint-index="${n}"]`),r=be(`#joint-value-${n}`);if(!s||!r)return;const a=t*180/Math.PI;e&&(It[n]=t,s.value=String(a)),r.textContent=`${Mi(a)}°`})}function Wi(i,e){i==null||i.setJointValues(Object.fromEntries(e.map((t,n)=>[`joint_${n+1}`,t]))),i==null||i.updateMatrixWorld(!0)}function Yu(i,e,t){var a;const n=xt==null?void 0:xt.robots.find(o=>o.id===i);if(!(e.length===6&&(n==null?void 0:n.joints.every((o,c)=>Number.isFinite(Number(e[c]))&&Number(e[c])>=o.lower_deg&&Number(e[c])<=o.upper_deg))))return Cn(i,"记录关节角超出限制"),!1;const r=e.map(o=>Number(o)*Math.PI/180);return bi[i]=[...r],rr[i]=!0,ki[i]=!0,i===ne&&(It=[...r],Da(r,!0)),Wi((a=Ei[i])==null?void 0:a.shadow,r),Cn(i,t),i===ne&&($n(i),jl(!0)),!0}function $u(i,e,t){i==null||i.traverse(n=>{n instanceof Tt&&(n.material=e?new er({color:14715474,transparent:!0,opacity:t===ne?.28:0,depthWrite:!1,depthTest:!1,side:mn}):new fp({color:lv[t],metalness:.25,roughness:.56,depthWrite:!0,depthTest:!0}),n.castShadow=!e,n.receiveShadow=!e,n.renderOrder=e?10:0,n.frustumCulled=!e)})}function $n(i){var n,s;const e=So?(n=Ei[So])==null?void 0:n.shadow:null;e==null||e.traverse(r=>{r instanceof Tt&&"opacity"in r.material&&(r.material.opacity=0)});const t=(s=Ei[i])==null?void 0:s.shadow;t==null||t.traverse(r=>{if(r instanceof Tt&&"opacity"in r.material){const a=ft===0||ft===1&&ki[i]?.28:0;r.material.opacity=a}}),So=i}function jl(i=!1){if(!xt||!Sn||!yi||!Hn)return;const e=new Xi;if(xt.robots.forEach(({id:r})=>{const a=Ei[r];a&&(e.expandByObject(a.live),i&&r===ne&&e.expandByObject(a.shadow))}),e.isEmpty())return;const t=e.getSize(new I),n=Math.max(t.x,t.y,t.z,.5),s=e.min.z+t.z*.36;yi.target.set(0,0,s),Sn.position.set(n*1.18,-n*1.65,s+n*.82),Sn.lookAt(yi.target),yi.update()}function vl(i){let e=0;return i==null||i.traverse(t=>{t instanceof Tt&&(e+=1)}),e}async function yv(i,e=7){for(let t=0;t<160;t+=1){if(i.every(n=>vl(n)>=e))return;await new Promise(n=>window.setTimeout(n,50))}throw new Error("URDF mesh loading timed out")}async function Mv(){var t;const i=++qu;zs.textContent="加载 URDF…",zs.removeAttribute("hidden");const e=new av;e.packages={rm65_description:`${location.origin}/models`};try{const n=await Promise.all(xt.robots.map(async l=>{const u=await e.loadAsync(`${location.origin}${l.urdf_url}`),d=await e.loadAsync(`${location.origin}${l.urdf_url}`);return{config:l,live:u,shadow:d}}));if(i!==qu)return;Hn.clear(),Hn.add(new Pp(15200493,2503736,2.5));const s=new Lh(16777215,4);s.position.set(2,-3,4),s.castShadow=!0,Hn.add(s);const r=new kp(3.5,22,5664888,2505536);r.rotation.x=Math.PI/2,Hn.add(r);const a=[],o=(t=xt.robots.find(l=>l.id==="m"))==null?void 0:t.transform;if(!o)throw new Error("middle-arm transform is missing from the layout manifest");n.forEach(({config:l,live:u,shadow:d})=>{u.position.set(l.transform.x-o.x,l.transform.y-o.y,l.transform.z-o.z),u.rotation.set(l.transform.roll,l.transform.pitch,l.transform.yaw,"ZYX"),d.position.set(l.transform.x-o.x,l.transform.y-o.y,l.transform.z-o.z),d.rotation.set(l.transform.roll,l.transform.pitch,l.transform.yaw,"ZYX"),Hn.add(u),Hn.add(d),Ei[l.id]={live:u,shadow:d},a.push(u,d)}),await yv(a),n.forEach(({config:l,live:u,shadow:d})=>{$u(u,!1,l.id),$u(d,!0,l.id),Wi(u,cr(l.id)),Wi(d,Yl(l.id)),u.updateMatrixWorld(!0)});const c=Na(ne);$n(ne),jl(!1),Xs.dataset.liveMeshes=String(n.reduce((l,{live:u})=>l+vl(u),0)),Xs.dataset.shadowMeshes=String(n.reduce((l,{shadow:u})=>l+vl(u),0)),Xs.dataset.visualizationReferenceArm="m",zs.setAttribute("hidden",""),be("#model-label").textContent=`${c.model} / ${ne.toUpperCase()} + 3 arms`}catch(n){zs.textContent=`URDF 加载失败: ${String(n)}`}}function bv(){hi=new Fx({canvas:Xu,antialias:!0,alpha:!0,preserveDrawingBuffer:!0}),hi.setPixelRatio(Math.min(window.devicePixelRatio,2)),hi.outputColorSpace=lt,hi.setClearColor(594196,1),hi.shadowMap.enabled=!0,Hn=new ph,Sn=new Bt(35,1,.01,100),Sn.up.set(0,0,1),Sn.position.set(1.2,-1.8,1.25),yi=new Bx(Sn,Xu),yi.enableDamping=!0,yi.target.set(0,0,.55);const i=()=>{const t=Xs.getBoundingClientRect();!t.width||!t.height||(hi.setSize(t.width,t.height,!1),Sn.aspect=t.width/t.height,Sn.updateProjectionMatrix())};new ResizeObserver(i).observe(Xs),i();const e=()=>{requestAnimationFrame(e),yi.update(),hi.render(Hn,Sn)};e()}function Ql(){const i=ga().motion;be("#velocity-frame").innerHTML=Object.entries(ga().frames).map(([n,s])=>`<option value="${n}">${n.toUpperCase()} / ${s.name}</option>`).join(""),be("#velocity-period").setAttribute("value",Ln(i.velocity_control_period_ms)),be("#velocity-watchdog").setAttribute("value",Ln(i.velocity_watchdog_ms)),be("#linear-accel").setAttribute("value",Ln(i.max_linear_accel_mps2)),be("#angular-accel").setAttribute("value",Ln(i.max_angular_accel_radps2));const e=["vx","vy","vz","wx","wy","wz"];be("#velocity-inputs").innerHTML=e.map((n,s)=>`<label>${n}<input id="velocity-${s}" type="number" step="0.01" value="0.00" /></label>`).join("");const t=Ia();if(t!=null&&t.preferred_reference){const n=t.preferred_reference.type===1?"work":t.preferred_reference.type===2?"tool":"base";be("#velocity-frame").value=n}}function Sv(i){var e,t,n,s,r,a,o,c,l;if(i.type==="hello")ea=!!i.read_only,Gu.textContent=ea?"READ ONLY":"CONTROL READY",Gu.classList.toggle("ready",!ea),i.layout&&cd(i.layout);else if(i.type==="coordinate_state")La[i.arm]=i,hs(),i.arm===ne&&($l(),xt&&Ql());else if(i.type==="tf_frames"){const u=i.arm;if(_l[u]=Array.isArray(i.frames)?i.frames:[],u===ne&&xt){const d=Dn(u);d.type===3&&!((e=_l[u])!=null&&e.some(h=>h.frame_id===d.frame_id))&&delete Bi[u],Kl(),ta(),Qe()}}else if(i.type==="connection")Wl[i.arm]=!!i.connected,hs(),i.arm===ne&&Jl();else if(i.type==="joint_state")Ss[i.arm]=i.positions_rad,rr[i.arm]||(bi[i.arm]=[...i.positions_rad]),Wi((t=Ei[i.arm])==null?void 0:t.live,i.positions_rad),i.arm===ne&&(Pa=i.positions_rad,be("#joint-stamp").textContent=`joint_states / ${i.stamp_ns||0}`),hs();else if(i.type==="joint_records")vi[i.arm]=Array.isArray(i.records)?i.records:[],ql[i.arm]||Cn(i.arm,`${((n=vi[i.arm])==null?void 0:n.length)??0} 条记录`),i.arm===ne&&Ys(),Qe();else if(i.type==="joint_record_saved"){const u=i.arm;delete pn[u],Cn(u,`已记录 ${((s=i.record)==null?void 0:s.label)??""}`),Ca.value="",u===ne&&Ys(),Qe()}else if(i.type==="joint_record_deleted"){const u=i.arm;if(pn[u]!==i.request_id)return;delete pn[u];const d=String(((r=i.record)==null?void 0:r.id)??"");vi[u]=(vi[u]??[]).filter(h=>h.id!==d),Cn(u,`已删除 ${((a=i.record)==null?void 0:a.label)??"记录"}`),u===ne&&Ys(),Qe()}else if(i.type==="joint_record_applied"){const u=i.arm;if(pn[u]!==i.request_id)return;delete pn[u];const d=Array.isArray(i.joint_degrees)?i.joint_degrees:[],h=Number(i.command);if(h===0)Yu(u,d,`已填入 ${((o=i.record)==null?void 0:o.label)??"记录"} / MOVEJ`);else{const f=Array.isArray(i.pose_position_m)?i.pose_position_m:[],g=Array.isArray(i.pose_quaternion_wxyz)?i.pose_quaternion_wxyz:[];if(i.success&&f.length===3&&g.length===4&&Yu(u,d,`已填入 ${((c=i.record)==null?void 0:c.label)??"记录"} / ${Hl[h]}`)){Si[u]=[...f,...g].map(m=>String(m));const y=i.reference;(y==null?void 0:y.type)===3&&(Bi[u]=y),ar[u]=[...f],An(u,`记录正解已填入 / ${ln(y??Dn(u))}`),u===ne&&ta()}else Cn(u,`记录正解失败 / ${i.message||"forward kinematics failed"}`)}Qe()}else if(i.type==="kinematics_result"){const u=i.arm;if(xi[u]!==i.request_id)return;if(delete xi[u],i.operation==="get_current_pose"){const d=Array.isArray(i.pose_position_m)?i.pose_position_m:[],h=Array.isArray(i.pose_quaternion_wxyz)?i.pose_quaternion_wxyz:[];if(i.success&&d.length===3&&h.length===4){Si[u]=[...d,...h].map(g=>String(g));const f=i.reference;(f==null?void 0:f.type)===3&&(Bi[u]=f),ar[u]=[...d],ki[u]=!1,An(u,`当前位置已填入 / ${ln(f??Dn(u))}`),u===ne&&ta(),u===ne&&$n(u)}else An(u,`当前位置读取失败 / ${i.message||"unknown error"}`)}else if(i.operation==="solve_ik"){const d=Array.isArray(i.joint_degrees)?i.joint_degrees:[],h=xt==null?void 0:xt.robots.find(g=>g.id===u);if(!!i.success&&d.length===6&&(h==null?void 0:h.joints.every((g,y)=>Number.isFinite(Number(d[y]))&&Number(d[y])>=g.lower_deg&&Number(d[y])<=g.upper_deg))){const g=d.map(y=>Number(y)*Math.PI/180);bi[u]=[...g],rr[u]=!0,ki[u]=!0,u===ne&&(It=[...g],Da(g,!0)),Wi((l=Ei[u])==null?void 0:l.shadow,g),An(u,`逆解成功 / 影子已更新 / ${d.map(y=>Number(y).toFixed(2)).join(", ")}°`),u===ne&&($n(u),jl(!0))}else ki[u]=!1,An(u,`逆解失败 / ${i.message||"target is unreachable"}`),u===ne&&$n(u)}Qe()}else if(i.type==="action_state"){if(i.arm!==ne){hs();return}qr.textContent=String(i.state).toUpperCase(),qr.className=`mini-state ${i.state}`,i.action==="cartesian_velocity"&&(cv.textContent=String(i.state).toUpperCase()),["rejected","error"].includes(i.state)&&(i.action==="execute_motion"&&(wn=""),i.action==="cartesian_velocity"&&(Rn="",window.clearInterval(Xn),Xn=0),Qe())}else if(i.type==="action_feedback"){if(i.arm!==ne)return;const u=i.feedback||{};gl.textContent=`${i.action} / ${u.detail||"executing"} / progress ${u.progress??"-"}`,Array.isArray(u.commanded_linear_velocity_mps)&&(gl.textContent=`velocity / ${u.commanded_linear_velocity_mps.map(d=>Mi(d)).join(", ")}`),uv.style.width=`${Math.max(0,Math.min(100,Number(u.progress||0)*100))}%`}else if(i.type==="action_result"){if(i.arm!==ne)return;fi.textContent=JSON.stringify(i.result,null,2),qr.textContent="RESULT",wn=i.action==="execute_motion"?"":wn,Rn=i.action==="cartesian_velocity"?"":Rn,Qe()}else if(i.type==="software_stop_result")fi.textContent=`软件停止: ${i.success?"成功":"失败"} / ${i.message}`;else if(i.type==="motion_recovery_state"){const u=i.arm;if(mi[u]!==i.request_id)return;fi.textContent=`${u.toUpperCase()} 恢复请求中 / ${i.state}`,Qe()}else if(i.type==="motion_recovery_result"){const u=i.arm;if(mi[u]!==i.request_id)return;delete mi[u];const d=i.success?i.recovered?"已恢复":"无需恢复":"恢复失败";fi.textContent=`${u.toUpperCase()} ${d} / ${i.message||"unknown error"}`,u===ne&&(qr.textContent=d.toUpperCase()),Qe()}else if(i.type==="error"){fi.textContent=`${i.code}: ${i.message}`,i.request_id===wn&&(wn=""),i.request_id===Rn&&(Rn="",window.clearInterval(Xn),Xn=0);for(const u of["l","m","r"])i.request_id===xi[u]&&(delete xi[u],An(u,`${i.code}: ${i.message}`)),i.request_id===pn[u]&&(delete pn[u],Cn(u,`${i.code}: ${i.message}`)),i.request_id===mi[u]&&(delete mi[u],fi.textContent=`${u.toUpperCase()} 恢复失败 / ${i.code}: ${i.message}`);Qe()}}function ld(){qt==null||qt.close();const i=location.protocol==="https:"?"wss":"ws";qt=new WebSocket(`${i}://${location.host}/ws`),qt.addEventListener("open",()=>xl(!0)),qt.addEventListener("close",()=>{xl(!1),Qe(),window.setTimeout(ld,2e3)}),qt.addEventListener("message",e=>{try{Sv(JSON.parse(e.data))}catch{fi.textContent="收到无法解析的服务器消息"}})}function Qe(){var s;const i=Qn(),e=!!sd()&&(ft===0||!!va());kl.disabled=!i||!!wn||!e,Yh.disabled=!i||!!Rn,$h.disabled=!i||!Rn,Xh.disabled=!i||!wn,qh.disabled=!i||!!mi[ne],Wh.disabled=!i;const t=!!xi[ne];Zh.disabled=!i||ft===0,zl.disabled=!i||ft!==1||t||!va();const n=!!pn[ne];jh.disabled=!i||n||Ca.value.trim()===""||(((s=Ss[ne])==null?void 0:s.length)??0)!==6,Qh.disabled=!i||n||!on.value,Gl.disabled=!i||ft!==0||n||!on.value}function cd(i){xt=i,ne=sr.value,i.robots.forEach(e=>{const t=e.joints.map(()=>i.default_joint_position_rad);Ss[e.id]=Ss[e.id]??[...t],bi[e.id]=bi[e.id]??[...t],Si[e.id]=Si[e.id]??["","","","1","0","0","0"],vi[e.id]=vi[e.id]??[],ma[e.id]=ma[e.id]??{velocity:Ln(30),timeout:Ln(e.motion.default_timeout_sec)}}),Pa=[...cr(ne)],It=[...Yl(ne)],be("#root-frame").textContent=`TF / ${i.root_frame}`,ha.textContent=ne.toUpperCase(),ha.className="mini-state active-arm",od(),Ys(),ad(),Ql(),$l(),hs(),Jl(),hi||bv(),Mv(),Qe()}Jh.addEventListener("click",()=>{var i;It=[...Pa],bi[ne]=[...It],rr[ne]=!0,Da(It,!0),Wi((i=xa())==null?void 0:i.shadow,It)});sr.addEventListener("change",()=>{ne=sr.value,wn="",Rn="",window.clearInterval(Xn),Xn=0,od(),$n(ne),gv();const i=Na(ne);be("#model-label").textContent=`${i.model} / ${ne.toUpperCase()} + 3 arms`});Kh.querySelectorAll("button[data-motion-command]").forEach(i=>{i.addEventListener("click",()=>{const e=Number(i.dataset.motionCommand);(e===0||e===1||e===2)&&rd(e)})});Hi().forEach(i=>{i.addEventListener("input",()=>{Si[ne]=Hi().map(e=>e.value),vv(),ki[ne]=!1,An(ne,td()),$n(ne),Qe()})});[fa,pa].forEach(i=>{i.addEventListener("input",()=>{ma[ne]={velocity:fa.value,timeout:pa.value},Qe()})});Ca.addEventListener("input",Qe);on.addEventListener("change",Qe);jh.addEventListener("click",()=>{if(!Qn())return;const i=Ca.value.trim();if(!i)return;const e=jn("save-record");pn[ne]=e,Cn(ne,"保存当前关节角…"),un({type:"save_joint_record",request_id:e,arm:ne,label:i}),Qe()});Qh.addEventListener("click",()=>{if(!Qn()||!on.value)return;const i=jn("apply-record");pn[ne]=i,Cn(ne,"读取记录…"),un({type:"apply_joint_record",request_id:i,arm:ne,record_id:on.value,command:ft,reference:ft===0?nd():{reference_type:Dn().type,reference_name:Dn().name}}),Qe()});Gl.addEventListener("click",()=>{var t;if(!Qn()||ft!==0||!on.value)return;const i=(t=vi[ne])==null?void 0:t.find(n=>n.id===on.value);if(!window.confirm(`删除关节记录“${(i==null?void 0:i.label)??on.value}”？此操作不可撤销。`))return;const e=jn("delete-record");pn[ne]=e,Cn(ne,"删除关节记录…"),un({type:"delete_joint_record",request_id:e,arm:ne,record_id:on.value}),Qe()});kl.addEventListener("click",()=>{const i=sd(),e=ft===0?null:va();if(!Qn()||!i||ft!==0&&!e)return;const t=Hl[ft];wn=jn(t.toLowerCase());const n=ft===0?nd():Dn();un({type:"execute_motion",request_id:wn,arm:ne,goal:{command:ft,reference_type:n.type,reference_name:n.name,joint_degrees:ft===0?It.map(s=>s*180/Math.PI):[0,0,0,0,0,0],pose_position_m:(e==null?void 0:e.position)??[0,0,0],pose_quaternion_wxyz:(e==null?void 0:e.quaternion)??[1,0,0,0],velocity_percent:i.velocity,blend_radius_percent:0,timeout_sec:i.timeout}}),gl.textContent=`${t} / ${ln(n)} / 等待 feedback…`,Qe()});Zh.addEventListener("click",()=>{ft!==0&&Zl(ne,!0)});zl.addEventListener("click",()=>{const i=va(),e=Dn(),t=cr(ne);if(!Qn()||ft!==1||!i||t.length!==6)return;const n=jn("solve-ik");xi[ne]=n,An(ne,"计算逆解…"),un({type:"solve_ik",request_id:n,arm:ne,goal:{reference_type:e.type,reference_name:e.name,seed_joint_degrees:t.map(s=>s*180/Math.PI),pose_position_m:i.position,pose_quaternion_wxyz:i.quaternion}}),Qe()});Yh.addEventListener("click",()=>{if(!Qn())return;const i=ga().frames[be("#velocity-frame").value];Rn=jn("velocity"),un({type:"start_cartesian_velocity",request_id:Rn,arm:ne,goal:{reference_type:i.type,reference_name:i.name,control_period_ms:Number(be("#velocity-period").value),watchdog_ms:Number(be("#velocity-watchdog").value),max_linear_accel_mps2:Number(be("#linear-accel").value),max_angular_accel_radps2:Number(be("#angular-accel").value),follow:!1,trajectory_mode:0,radio:0}}),Qe(),Xn=window.setInterval(()=>{const e=Array.from({length:6},(t,n)=>Number(be(`#velocity-${n}`).value));un({type:"velocity_command",arm:ne,linear:e.slice(0,3),angular:e.slice(3)})},20)});qs.addEventListener("change",()=>{const i=id(ne).find(e=>(e.frame_id??e.name)===qs.value);i&&(Bi[ne]=i,da.textContent=ln(i),ar[ne]=void 0,Zl(ne,!0))});$h.addEventListener("click",()=>{un({type:"cancel_action",arm:ne,action:"cartesian_velocity"}),window.clearInterval(Xn),Xn=0});Xh.addEventListener("click",()=>{un({type:"cancel_action",arm:ne,action:"execute_motion"})});Wh.addEventListener("click",()=>{un({type:"software_stop",request_id:jn("stop"),arm:ne})});qh.addEventListener("click",()=>{if(!Qn()||mi[ne])return;const i=jn("recover");mi[ne]=i,fi.textContent=`${ne.toUpperCase()} 恢复请求中…`,un({type:"recover_motion",request_id:i,arm:ne}),Qe()});fetch("/api/layout").then(i=>i.json()).then(cd).catch(i=>{zs.textContent=`布局加载失败: ${String(i)}`});ld();
