...
| [WebSocket 浏览器控制与 URDF 影子](./realman-web-control) | WebSocket 授权、Action feedback/result、滑轨影子、软件停止和测试 | `config/ros/realman_web_control.yaml`、`src/driver/realman_web_control/` |
