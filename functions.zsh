...
rm65_project_help() {
  ...
  print -r -- "  ./rm65 bt [tree-name|l|m|r|three|control]   从 config/behavior-trees 启动行为树；.xml 可省略"
  ...
  print -r -- "REALMAN_START_WEB_CONTROL, REALMAN_JOINT_RECORD_DIR,"
  print -r -- "REALMAN_WAIT_FOR_JOY_DEVICE, REALMAN_JOY_POLL_INTERVAL,"
