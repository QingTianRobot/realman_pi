...
`;const fe=i=>document.querySelector(i),Pv={l:2988957,m:13924166,r:8688794},gr=fe("#arm-select"),sh=fe("#connection"),rh=fe("#mode"),ud=fe("#stop-button"),hd=fe("#cancel-motion"),dd=fe("#recover-motion"),ec=fe("#execute-motion"),fd=fe("#start-velocity"),pd=fe("#cancel-velocity"),ra=fe("#action-state"),Lv=fe("#velocity-state"),ah=fe("#coordinate-state"),oh=fe("#coordinate-summary"),qn=fe("#feedback"),xi=fe("#result"),Fo=fe("#progress"),Ks=fe("#viewer-state"),lh=fe("#canvas"),tr=fe("#viewer"),Oo=fe("#fleet-strip"),Ta=fe("#selected-arm-label"),Nv=fe("#input-mode-card"),Hi=fe("#input-mode-select"),ch=fe("#input-mode-active"),Iv=fe("#input-mode-detail"),md=fe("#motion-mode"),Dv=fe("#joint-target"),Uv=fe("#pose-target"),nr=fe("#pose-reference-frame"),fa=fe("#pose-sliders"),Fv=fe("#pose-kinematics-actions"),gd=fe("#fill-current-pose"),tc=fe("#solve-ik"),nc=fe("#kinematics-status"),_d=fe("#reset-preview"),Aa=fe("#motion-reference"),wa=fe("#motion-velocity"),Ra=fe("#motion-timeout"),Ha=fe("#record-name"),xd=fe("#save-record"),un=fe("#record-select"),vd=fe("#apply-record"),ic=fe("#delete-record"),yd=fe("#record-status"),Ov=["pose-x","pose-y","pose-z","pose-qw","pose-qx","pose-qy","pose-qz"],sc={0:"MOVEJ",1:"MOVEL",2:"MOVEP"},Bv={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};let xt,ne="l",ft=0,Dt=[],Wa=[],Yt;const bd={};let Wi="",pa=!1,Kt,hn,ir="",yn="",Zn,Xi="",Et="",xn=0,In="",Jn=0;const Xa={},rc={},Ns={},Bo={},uh={},wi={},_r={},Ri={},qi={},Nl={},xr={},ac={},Si={},Yi={},Ca={},Ei={},oc={},$i={},sr={},yi={},Ci={};let gi,Yn,Cn,Ti,ko=null,hh=0;function Pa(){if(!xt)throw new Error("manifest not loaded");return xt.robots.find(i=>i.id===ne)}function qa(i){if(!xt)throw new Error("manifest not loaded");return xt.robots.find(e=>e.id===i)}function Sn(i){return`${i}-${Date.now()}-${Math.random().toString(16).slice(2,8)}`}function pn(){return!pa&&(Yt==null?void 0:Yt.readyState)===WebSocket.OPEN}function kv(i){var e;return((e=Kt==null?void 0:Kt.find(t=>t.id===i))==null?void 0:e.label)??i}function Md(){Hi.disabled=!pn()||!!yn||(hn==null?void 0:hn.phase)==="SWITCHING"||!(Kt!=null&&Kt.some(i=>i.id!=="web"&&i.selectable))}function Zs(){if(Nv.hidden=!Kt,!Kt)return;const i=(hn==null?void 0:hn.selected_mode)??Xi;Hi.replaceChildren(...Kt.filter(t=>t.id!=="web").map(t=>{const n=document.createElement("option");return n.value=t.id,n.textContent=t.label,n.disabled=!t.selectable,n})),i&&Array.from(Hi.options).some(t=>t.value===i)?Hi.value=i:Hi.selectedIndex=-1;const e=hn;ch.textContent=e?`${kv(e.active_mode)} / ${e.phase}`:"WAIT",ch.className=`mini-state ${(e==null?void 0:e.phase.toLowerCase())??""}`,Iv.textContent=(e==null?void 0:e.detail)||ir||"等待输入模式状态",Md()}function dh(){!yn||Zn===void 0||!hn||hn.request_id!==Zn||!["ACTIVE","FAILED"].includes(hn.phase)||(yn="",Zn=void 0,Xi="")}function Ai(i,e=2){return Number.isFinite(i)?i.toFixed(e):""}function Un(i,e=2){const t=Number(i);return Number.isFinite(t)?t.toFixed(e):String(i??"")}function dn(i){return i?`${i.type===1?"WORK":i.type===2?"TOOL":i.type===3?"TF":"BASE"} / ${i.name}`:"BASE / base"}function La(i){return i.replace(/[&<>"']/g,e=>Bv[e]??e)}function Ya(){return Xa[ne]}function Na(){return Ci[ne]}function br(i){const e=qa(i);return Ns[i]??e.joints.map(()=>xt.default_joint_position_rad)}function lc(i){return wi[i]??br(i)}function Sd(i=ft){return i===1?"位姿已修改：影子等待“计算逆解”成功后更新":i===2?"MOVEP 位姿目标已修改：MOVEP 不提供逆解/影子预览，影子不会跟随滑轨；可直接发送 MOVEP":"位姿已修改"}function zv(){var i;Wa=[...br(ne)],Dt=[...lc(ne)],$a(Dt,!0),Rd(),(i=Na())!=null&&i.shadow&&Qi(Na().shadow,Dt),Ta.textContent=ne.toUpperCase(),Ta.className="mini-state active-arm",cc(),nc.textContent=ac[ne]??"MOVEL 逆解仅更新影子预览",mc(),ys(),fc(),je()}function cc(){var e,t,n,s,r;const i=Ya();if(Aa.textContent=dn(i==null?void 0:i.preferred_reference),ah.textContent=i?i.motion_allowed?"READY":"BLOCKED":"WAIT",ah.className=i?`mini-state ${i.motion_allowed?"accepted":"stopping"}`:"mini-state",!i){oh.innerHTML='<div class="coordinate-empty">等待坐标状态</div>';return}oh.innerHTML=`
  ...
  `).join(""),i.querySelectorAll("input[data-joint-index]").forEach(e=>e.addEventListener("input",()=>{var n,s;const t=Number(e.dataset.jointIndex);Dt[t]=Number(e.value)*Math.PI/180,wi[ne]=[...Dt],_r[ne]=!0,fe(`#joint-value-${t}`).textContent=`${Ai(Number(e.value))}°`,(s=(n=Na())==null?void 0:n.shadow)==null||s.setJointValues(Object.fromEntries(Dt.map((r,a)=>[`joint_${a+1}`,r])))}))}function $a(i,e=!1){i.forEach((t,n)=>{const s=fe(`input[data-joint-index="${n}"]`),r=fe(`#joint-value-${n}`);if(!s||!r)return;const a=t*180/Math.PI;e&&(Dt[n]=t,s.value=String(a)),r.textContent=`${Ai(a)}°`})}function Qi(i,e){i==null||i.setJointValues(Object.fromEntries(e.map((t,n)=>[`joint_${n+1}`,t]))),i==null||i.updateMatrixWorld(!0)}function fh(i,e,t){var a;const n=xt==null?void 0:xt.robots.find(o=>o.id===i);if(!(e.length===6&&(n==null?void 0:n.joints.every((o,c)=>Number.isFinite(Number(e[c]))&&Number(e[c])>=o.lower_deg&&Number(e[c])<=o.upper_deg))))return $n(i,"记录关节角超出限制"),!1;const r=e.map(o=>Number(o)*Math.PI/180);return wi[i]=[...r],_r[i]=!0,Yi[i]=!0,i===ne&&(Dt=[...r],$a(r,!0)),Qi((a=Ci[i])==null?void 0:a.shadow,r),$n(i,t),i===ne&&(ti(i),pc(!0)),!0}function ph(i,e,t){i==null||i.traverse(n=>{n instanceof At&&(n.material=e?new dr({color:14715474,transparent:!0,opacity:t===ne?.28:0,depthWrite:!1,depthTest:!1,side:vn}):new Up({color:Pv[t],metalness:.25,roughness:.56,depthWrite:!0,depthTest:!0}),n.castShadow=!e,n.receiveShadow=!e,n.renderOrder=e?10:0,n.frustumCulled=!e)})}function ti(i){var n,s;const e=ko?(n=Ci[ko])==null?void 0:n.shadow:null;e==null||e.traverse(r=>{r instanceof At&&"opacity"in r.material&&(r.material.opacity=0)});const t=(s=Ci[i])==null?void 0:s.shadow;t==null||t.traverse(r=>{if(r instanceof At&&"opacity"in r.material){const a=ft===0||ft===1&&Yi[i]?.28:0;r.material.opacity=a}}),ko=i}function pc(i=!1){if(!xt||!Cn||!Ti||!Yn)return;const e=new es;if(xt.robots.forEach(({id:r})=>{const a=Ci[r];a&&(e.expandByObject(a.live),i&&r===ne&&e.expandByObject(a.shadow))}),e.isEmpty())return;const t=e.getSize(new I),n=Math.max(t.x,t.y,t.z,.5),s=e.min.z+t.z*.36;Ti.target.set(0,0,s),Cn.position.set(n*1.18,-n*1.65,s+n*.82),Cn.lookAt(Ti.target),Ti.update()}function Dl(i){let e=0;return i==null||i.traverse(t=>{t instanceof At&&(e+=1)}),e}async function Wv(i,e=7){for(let t=0;t<160;t+=1){if(i.every(n=>Dl(n)>=e))return;await new Promise(n=>window.setTimeout(n,50))}throw new Error("URDF mesh loading timed out")}async function Xv(){var t;const i=++hh;Ks.textContent="加载 URDF…",Ks.removeAttribute("hidden");const e=new Rv;e.packages={rm65_description:`${location.origin}/models`};try{const n=await Promise.all(xt.robots.map(async l=>{const u=await e.loadAsync(`${location.origin}${l.urdf_url}`),h=await e.loadAsync(`${location.origin}${l.urdf_url}`);return{config:l,live:u,shadow:h}}));if(i!==hh)return;Yn.clear(),Yn.add(new jp(15200493,2503736,2.5));const s=new Jh(16777215,4);s.position.set(2,-3,4),s.castShadow=!0,Yn.add(s);const r=new om(3.5,22,5664888,2505536);r.rotation.x=Math.PI/2,Yn.add(r);const a=[],o=(t=xt.robots.find(l=>l.id==="m"))==null?void 0:t.transform;if(!o)throw new Error("middle-arm transform is missing from the layout manifest");n.forEach(({config:l,live:u,shadow:h})=>{u.position.set(l.transform.x-o.x,l.transform.y-o.y,l.transform.z-o.z),u.rotation.set(l.transform.roll,l.transform.pitch,l.transform.yaw,"ZYX"),h.position.set(l.transform.x-o.x,l.transform.y-o.y,l.transform.z-o.z),h.rotation.set(l.transform.roll,l.transform.pitch,l.transform.yaw,"ZYX"),Yn.add(u),Yn.add(h),Ci[l.id]={live:u,shadow:h},a.push(u,h)}),await Wv(a),n.forEach(({config:l,live:u,shadow:h})=>{ph(u,!1,l.id),ph(h,!0,l.id),Qi(u,br(l.id)),Qi(h,lc(l.id)),u.updateMatrixWorld(!0)});const c=qa(ne);ti(ne),pc(!1),tr.dataset.liveMeshes=String(n.reduce((l,{live:u})=>l+Dl(u),0)),tr.dataset.shadowMeshes=String(n.reduce((l,{shadow:u})=>l+Dl(u),0)),tr.dataset.visualizationReferenceArm="m",Ks.setAttribute("hidden",""),fe("#model-label").textContent=`${c.model} / ${ne.toUpperCase()} + 3 arms`}catch(n){Ks.textContent=`URDF 加载失败: ${String(n)}`}}function qv(){gi=new sv({canvas:lh,antialias:!0,alpha:!0,preserveDrawingBuffer:!0}),gi.setPixelRatio(Math.min(window.devicePixelRatio,2)),gi.outputColorSpace=lt,gi.setClearColor(594196,1),gi.shadowMap.enabled=!0,Yn=new Dh,Cn=new kt(35,1,.01,100),Cn.up.set(0,0,1),Cn.position.set(1.2,-1.8,1.25),Ti=new av(Cn,lh),Ti.enableDamping=!0,Ti.target.set(0,0,.55);const i=()=>{const t=tr.getBoundingClientRect();!t.width||!t.height||(gi.setSize(t.width,t.height,!1),Cn.aspect=t.width/t.height,Cn.updateProjectionMatrix())};new ResizeObserver(i).observe(tr),i();const e=()=>{requestAnimationFrame(e),Ti.update(),gi.render(Yn,Cn)};e()}function mc(){const i=Pa().motion;fe("#velocity-frame").innerHTML=Object.entries(Pa().frames).map(([n,s])=>`<option value="${n}">${n.toUpperCase()} / ${s.name}</option>`).join(""),fe("#velocity-period").setAttribute("value",Un(i.velocity_control_period_ms)),fe("#velocity-watchdog").setAttribute("value",Un(i.velocity_watchdog_ms)),fe("#linear-accel").setAttribute("value",Un(i.max_linear_accel_mps2)),fe("#angular-accel").setAttribute("value",Un(i.max_angular_accel_radps2));const e=["vx","vy","vz","wx","wy","wz"];fe("#velocity-inputs").innerHTML=e.map((n,s)=>`<label>${n}<input id="velocity-${s}" type="number" step="0.01" value="0.00" /></label>`).join("");const t=Ya();if(t!=null&&t.preferred_reference){const n=t.preferred_reference.type===1?"work":t.preferred_reference.type===2?"tool":"base";fe("#velocity-frame").value=n}}function Mr(i,e={}){!Wi||!pn()||Zt({type:"gripper_command",request_id:Sn("gripper"),name:Wi,command:i,...e})}function gc(){const i=bd[Wi];i&&(fe("#gripper-state").textContent=i.connected?"ONLINE":"OFFLINE",fe("#gripper-feedback").textContent=`位置 ${i.position??0} / 速度 ${i.speed??0} / 电流 ${i.current??0} / 力矩 ${i.torque_reached?"到达":"未到达"} / 报警 0x${Number(i.alarm??0).toString(16)}`)}function Yv(i){const e=fe("#gripper-select");e.innerHTML=i.map(t=>`<option value="${String(t.name)}">${String(t.name)}</option>`).join(""),!Wi&&i.length&&(Wi=String(i[0].name)),e.value=Wi,gc()}function $v(i){var e,t,n,s,r,a,o,c,l,u;if(i.type==="hello")pa=!!i.read_only,rh.textContent=pa?"READ ONLY":"CONTROL READY",rh.classList.toggle("ready",!pa),i.layout&&Ld(i.layout);else if(i.type==="input_mode_list")i.available?Kt=Array.isArray(i.modes)?i.modes.reduce((h,d)=>(typeof(d==null?void 0:d.id)=="string"&&typeof(d==null?void 0:d.label)=="string"&&typeof(d==null?void 0:d.selectable)=="boolean"&&h.push({id:d.id,label:d.label,selectable:d.selectable}),h),[]):[]:(Kt=void 0,hn=void 0,ir="",yn="",Zn=void 0,Xi=""),Zs();else if(i.type==="input_mode_result"){const h={request_id:String(i.request_id??""),executor_request_id:Number(i.executor_request_id),accepted:!!i.accepted,message:String(i.message??"")};h.request_id===yn&&(ir=h.message,h.accepted&&Number.isFinite(h.executor_request_id)?(Zn=h.executor_request_id,dh()):(yn="",Zn=void 0,Xi=""),Zs())}else if(i.type==="input_mode_state")hn={requested_mode:String(i.requested_mode??""),selected_mode:String(i.selected_mode??""),active_mode:String(i.active_mode??""),phase:String(i.phase??""),request_id:Number(i.request_id),epoch:Number(i.epoch),detail:String(i.detail??"")},dh(),Zs();else if(i.type==="gripper_list")Yv(Array.isArray(i.grippers)?i.grippers:[]);else if(i.type==="gripper_state")bd[String(i.name)]=i,gc();else if(i.type==="gripper_result")i.message&&(fe("#gripper-feedback").textContent=String(i.message));else if(i.type==="coordinate_state")Xa[i.arm]=i,ys(),i.arm===ne&&(cc(),xt&&mc());else if(i.type==="tf_frames"){const h=i.arm;if(Nl[h]=Array.isArray(i.frames)?i.frames:[],h===ne&&xt){const d=ei(h);d.type===3&&!((e=Nl[h])!=null&&e.some(f=>f.frame_id===d.frame_id))&&delete qi[h],uc(),ma(),je()}}else if(i.type==="connection")rc[i.arm]=!!i.connected,ys(),i.arm===ne&&fc();else if(i.type==="joint_state"){const h=i.arm,d=Array.isArray(i.positions_rad)?i.positions_rad.map(Number):[],f=Number(i.stamp_ns);if(!["l","m","r"].includes(h)||d.length!==6||!d.every(Number.isFinite)||!Number.isFinite(f)||f<=0||Bo[h]!==void 0&&f<=Bo[h])return;const g=d.every(y=>y===0);if(g&&uh[h])return;Bo[h]=f,g||(uh[h]=!0),Ns[h]=d,_r[h]||(wi[h]=[...d]),Qi((t=Ci[h])==null?void 0:t.live,d),h===ne&&(Wa=d,fe("#joint-stamp").textContent=`joint_states / ${f}`),ys()}else if(i.type==="joint_records")Ei[i.arm]=Array.isArray(i.records)?i.records:[],oc[i.arm]||$n(i.arm,`${((n=Ei[i.arm])==null?void 0:n.length)??0} 条记录`),i.arm===ne&&rr(),je();else if(i.type==="joint_record_saved"){const h=i.arm;if(!aa(h,i.request_id))return;$n(h,`已记录 ${((s=i.record)==null?void 0:s.label)??""}`),Ha.value="",h===ne&&rr(),je()}else if(i.type==="joint_record_deleted"){const h=i.arm;if(!aa(h,i.request_id))return;const d=String(((r=i.record)==null?void 0:r.id)??"");Ei[h]=(Ei[h]??[]).filter(f=>f.id!==d),$n(h,`已删除 ${((a=i.record)==null?void 0:a.label)??"记录"}`),h===ne&&rr(),je()}else if(i.type==="joint_record_applied"){const h=i.arm;if(!aa(h,i.request_id))return;const d=Array.isArray(i.joint_degrees)?i.joint_degrees:[],f=Number(i.command);if(f===0)fh(h,d,`已填入 ${((o=i.record)==null?void 0:o.label)??"记录"} / MOVEJ`);else{const g=Array.isArray(i.pose_position_m)?i.pose_position_m:[],y=Array.isArray(i.pose_quaternion_wxyz)?i.pose_quaternion_wxyz:[];if(i.success&&g.length===3&&y.length===4&&fh(h,d,`已填入 ${((c=i.record)==null?void 0:c.label)??"记录"} / ${sc[f]}`)){Ri[h]=[...g,...y].map(p=>String(p));const m=i.reference;(m==null?void 0:m.type)===3&&(qi[h]=m),xr[h]=[...g],Nn(h,`记录正解已填入 / ${dn(m??ei(h))}`),h===ne&&ma()}else $n(h,`记录正解失败 / ${i.message||"forward kinematics failed"}`)}je()}else if(i.type==="kinematics_result"){const h=i.arm;if(Si[h]!==i.request_id)return;if(delete Si[h],i.operation==="get_current_pose"){const d=Array.isArray(i.pose_position_m)?i.pose_position_m:[],f=Array.isArray(i.pose_quaternion_wxyz)?i.pose_quaternion_wxyz:[];if(i.success&&d.length===3&&f.length===4){Ri[h]=[...d,...f].map(y=>String(y));const g=i.reference;(g==null?void 0:g.type)===3&&(qi[h]=g),xr[h]=[...d],Yi[h]=!1,Nn(h,`当前位置已填入 / ${dn(g??ei(h))}`),h===ne&&ma(),h===ne&&ti(h)}else Nn(h,`当前位置读取失败 / ${i.message||"unknown error"}`)}else if(i.operation==="solve_ik"){const d=Array.isArray(i.joint_degrees)?i.joint_degrees:[],f=xt==null?void 0:xt.robots.find(y=>y.id===h);if(!!i.success&&d.length===6&&(f==null?void 0:f.joints.every((y,m)=>Number.isFinite(Number(d[m]))&&Number(d[m])>=y.lower_deg&&Number(d[m])<=y.upper_deg))){const y=d.map(m=>Number(m)*Math.PI/180);wi[h]=[...y],_r[h]=!0,Yi[h]=!0,h===ne&&(Dt=[...y],$a(y,!0)),Qi((l=Ci[h])==null?void 0:l.shadow,y),Nn(h,`逆解成功 / 影子已更新 / ${d.map(m=>Number(m).toFixed(2)).join(", ")}°`),h===ne&&(ti(h),pc(!0))}else Yi[h]=!1,Nn(h,`逆解失败 / ${i.message||"target is unreachable"}`),h===ne&&ti(h)}je()}else if(i.type==="action_state"){if(i.arm!==ne){ys();return}if(i.action==="execute_motion"&&Et&&i.request_id&&i.request_id!==Et)return;ra.textContent=String(i.state).toUpperCase(),ra.className=`mini-state ${i.state}`,i.action==="cartesian_velocity"&&(Lv.textContent=String(i.state).toUpperCase()),["rejected","error"].includes(i.state)&&(i.action==="execute_motion"&&(window.clearTimeout(xn),xn=0,qn.textContent=`${i.action} / ${i.message||`action ${i.state}`}`,Fo.style.width="0%",Et=""),i.action==="cartesian_velocity"&&(In="",window.clearInterval(Jn),Jn=0),je())}else if(i.type==="action_feedback"){if(i.arm!==ne)return;if(i.action==="execute_motion"){if(Et&&i.request_id&&i.request_id!==Et)return;window.clearTimeout(xn),xn=0}const h=i.feedback||{};qn.textContent=`${i.action} / ${h.detail||"executing"} / progress ${h.progress??"-"}`,Array.isArray(h.commanded_linear_velocity_mps)&&(qn.textContent=`velocity / ${h.commanded_linear_velocity_mps.map(d=>Ai(d)).join(", ")}`),Fo.style.width=`${Math.max(0,Math.min(100,Number(h.progress||0)*100))}%`}else if(i.type==="action_result"){if(i.arm!==ne)return;if(i.action==="execute_motion"){if(Et&&i.request_id&&i.request_id!==Et)return;window.clearTimeout(xn),xn=0,(qn.textContent.includes("等待 feedback")||qn.textContent.includes("尚未收到"))&&(qn.textContent=`${i.action} / ${((u=i.result)==null?void 0:u.message)||"已收到运行结果"}`)}xi.textContent=JSON.stringify(i.result,null,2),ra.textContent="RESULT",Et=i.action==="execute_motion"?"":Et,In=i.action==="cartesian_velocity"?"":In,je()}else if(i.type==="software_stop_result")xi.textContent=`软件停止: ${i.success?"成功":"失败"} / ${i.message}`;else if(i.type==="motion_recovery_state"){const h=i.arm;if(yi[h]!==i.request_id)return;xi.textContent=`${h.toUpperCase()} 恢复请求中 / ${i.state}`,je()}else if(i.type==="motion_recovery_result"){const h=i.arm;if(yi[h]!==i.request_id)return;delete yi[h];const d=i.success?i.recovered?"已恢复":"无需恢复":"恢复失败";xi.textContent=`${h.toUpperCase()} ${d} / ${i.message||"unknown error"}`,h===ne&&(ra.textContent=d.toUpperCase()),je()}else if(i.type==="error"){xi.textContent=`${i.code}: ${i.message}`,i.request_id===yn&&(ir=`${i.code}: ${i.message}`,yn="",Zn=void 0,Xi="",Zs()),Et&&i.request_id===Et&&(window.clearTimeout(xn),xn=0,qn.textContent=`execute_motion / ${i.code}: ${i.message}`,Fo.style.width="0%",Et=""),i.request_id===In&&(In="",window.clearInterval(Jn),Jn=0);for(const h of["l","m","r"])i.request_id===Si[h]&&(delete Si[h],Nn(h,`${i.code}: ${i.message}`)),i.request_id===$i[h]&&(aa(h,i.request_id),$n(h,`${i.code}: ${i.message}`)),i.request_id===yi[h]&&(delete yi[h],xi.textContent=`${h.toUpperCase()} 恢复失败 / ${i.code}: ${i.message}`);je()}}function Pd(){Yt==null||Yt.close();const i=location.protocol==="https:"?"wss":"ws";Yt=new WebSocket(`${i}://${location.host}/ws`),Yt.addEventListener("open",()=>Il(!0)),Yt.addEventListener("close",()=>{Il(!1),yn="",Zn=void 0,Xi="",je(),window.setTimeout(Pd,2e3)}),Yt.addEventListener("message",e=>{try{$v(JSON.parse(e.data))}catch{xi.textContent="收到无法解析的服务器消息"}})}function je(){var s;const i=pn(),e=!!Ad()&&(ft===0||!!Ia());ec.disabled=!i||!!Et||!e,fd.disabled=!i||!!In,pd.disabled=!i||!In,hd.disabled=!i||!Et,dd.disabled=!i||!!yi[ne],ud.disabled=!i;const t=!!Si[ne];gd.disabled=!i||ft===0,tc.disabled=!i||ft!==1||t||!Ia();const n=!!$i[ne];xd.disabled=!i||n||Ha.value.trim()===""||(((s=Ns[ne])==null?void 0:s.length)??0)!==6,vd.disabled=!i||n||!un.value,ic.disabled=!i||ft!==0||n||!un.value,Md()}function Ld(i){xt=i,ne=gr.value,i.robots.forEach(e=>{const t=e.joints.map(()=>i.default_joint_position_rad);Ns[e.id]=Ns[e.id]??[...t],wi[e.id]=wi[e.id]??[...t],Ri[e.id]=Ri[e.id]??["","","","1","0","0","0"],Ei[e.id]=Ei[e.id]??[],Ca[e.id]=Ca[e.id]??{velocity:Un(30),timeout:Un(e.motion.default_timeout_sec)}}),Wa=[...br(ne)],Dt=[...lc(ne)],fe("#root-frame").textContent=`TF / ${i.root_frame}`,Ta.textContent=ne.toUpperCase(),Ta.className="mini-state active-arm",Cd(),rr(),Rd(),mc(),cc(),ys(),fc(),gi||qv(),Xv(),je()}_d.addEventListener("click",()=>{var i;Dt=[...Wa],wi[ne]=[...Dt],_r[ne]=!0,$a(Dt,!0),Qi((i=Na())==null?void 0:i.shadow,Dt)});gr.addEventListener("change",()=>{ne=gr.value,Et="",In="",window.clearInterval(Jn),Jn=0,Cd(),ti(ne),zv();const i=qa(ne);fe("#model-label").textContent=`${i.model} / ${ne.toUpperCase()} + 3 arms`});Hi.addEventListener("change",()=>{const i=Kt==null?void 0:Kt.find(e=>e.id===Hi.value);!i||!i.selectable||i.id==="web"||!pn()||(yn=Sn("input-mode"),Zn=void 0,Xi=i.id,ir=`请求切换到 ${i.label}…`,Zs(),Zt({type:"select_input_mode",request_id:yn,mode_id:i.id}))});md.querySelectorAll("button[data-motion-command]").forEach(i=>{i.addEventListener("click",()=>{const e=Number(i.dataset.motionCommand);(e===0||e===1||e===2)&&wd(e)})});ji().forEach(i=>{i.addEventListener("input",()=>{Ri[ne]=ji().map(e=>e.value),Hv(),Yi[ne]=!1,Nn(ne,Sd()),ti(ne),je()})});[wa,Ra].forEach(i=>{i.addEventListener("input",()=>{Ca[ne]={velocity:wa.value,timeout:Ra.value},je()})});Ha.addEventListener("input",je);un.addEventListener("change",je);xd.addEventListener("click",()=>{if(!pn())return;const i=Ha.value.trim();if(!i)return;const e=Sn("save-record");dc(ne,e,"保存当前关节角…"),Zt({type:"save_joint_record",request_id:e,arm:ne,label:i}),je()});vd.addEventListener("click",()=>{if(!pn()||!un.value)return;const i=Sn("apply-record"),e=ft===0?Ed():ei();dc(ne,i,"读取记录…"),Zt({type:"apply_joint_record",request_id:i,arm:ne,record_id:un.value,command:ft,reference:{reference_type:e.type,reference_name:e.name}}),je()});ic.addEventListener("click",()=>{var t;if(!pn()||ft!==0||!un.value)return;const i=(t=Ei[ne])==null?void 0:t.find(n=>n.id===un.value);if(!window.confirm(`删除关节记录“${(i==null?void 0:i.label)??un.value}”？此操作不可撤销。`))return;const e=Sn("delete-record");dc(ne,e,"删除关节记录…"),Zt({type:"delete_joint_record",request_id:e,arm:ne,record_id:un.value}),je()});ec.addEventListener("click",()=>{const i=Ad(),e=ft===0?null:Ia();if(!pn()||!i||ft!==0&&!e)return;const t=sc[ft];Et=Sn(t.toLowerCase());const n=ft===0?Ed():ei();Zt({type:"execute_motion",request_id:Et,arm:ne,goal:{command:ft,reference_type:n.type,reference_name:n.name,joint_degrees:ft===0?Dt.map(a=>a*180/Math.PI):[0,0,0,0,0,0],pose_position_m:(e==null?void 0:e.position)??[0,0,0],pose_quaternion_wxyz:(e==null?void 0:e.quaternion)??[1,0,0,0],velocity_percent:i.velocity,blend_radius_percent:0,timeout_sec:i.timeout}}),qn.textContent=`${t} / ${dn(n)} / 等待 feedback…`,window.clearTimeout(xn);const s=Et,r=ne;xn=window.setTimeout(()=>{xn=0,!(Et!==s||ne!==r)&&(qn.textContent=`${t} / 尚未收到 Action feedback；运行状态未知，请勿重复发送。检查 /${r}/execute_motion 和驱动日志，必要时使用软件停止。`)},8e3),je()});gd.addEventListener("click",()=>{ft!==0&&hc(ne,!0)});tc.addEventListener("click",()=>{const i=Ia(),e=ei(),t=br(ne);if(!pn()||ft!==1||!i||t.length!==6)return;const n=Sn("solve-ik");Si[ne]=n,Nn(ne,"计算逆解…"),Zt({type:"solve_ik",request_id:n,arm:ne,goal:{reference_type:e.type,reference_name:e.name,seed_joint_degrees:t.map(s=>s*180/Math.PI),pose_position_m:i.position,pose_quaternion_wxyz:i.quaternion}}),je()});fd.addEventListener("click",()=>{if(!pn())return;const i=Pa().frames[fe("#velocity-frame").value];In=Sn("velocity"),Zt({type:"start_cartesian_velocity",request_id:In,arm:ne,goal:{reference_type:i.type,reference_name:i.name,control_period_ms:Number(fe("#velocity-period").value),watchdog_ms:Number(fe("#velocity-watchdog").value),max_linear_accel_mps2:Number(fe("#linear-accel").value),max_angular_accel_radps2:Number(fe("#angular-accel").value),follow:!1,trajectory_mode:0,radio:0}}),je(),Jn=window.setInterval(()=>{const e=Array.from({length:6},(t,n)=>Number(fe(`#velocity-${n}`).value));Zt({type:"velocity_command",arm:ne,linear:e.slice(0,3),angular:e.slice(3)})},20)});nr.addEventListener("change",()=>{const i=Td(ne).find(e=>(e.frame_id??e.name)===nr.value);i&&(qi[ne]=i,Aa.textContent=dn(i),xr[ne]=void 0,hc(ne,!0))});pd.addEventListener("click",()=>{Zt({type:"cancel_action",arm:ne,action:"cartesian_velocity"}),window.clearInterval(Jn),Jn=0});hd.addEventListener("click",()=>{Zt({type:"cancel_action",arm:ne,action:"execute_motion"})});ud.addEventListener("click",()=>{Zt({type:"software_stop",request_id:Sn("stop"),arm:ne})});dd.addEventListener("click",()=>{if(!pn()||yi[ne])return;const i=Sn("recover");yi[ne]=i,xi.textContent=`${ne.toUpperCase()} 恢复请求中…`,Zt({type:"recover_motion",request_id:i,arm:ne}),je()});fetch("/api/layout").then(i=>i.json()).then(Ld).catch(i=>{Ks.textContent=`布局加载失败: ${String(i)}`});fe("#gripper-select").addEventListener("change",i=>{Wi=i.target.value,gc()});fe("#gripper-open").addEventListener("click",()=>Mr("open"));fe("#gripper-close").addEventListener("click",()=>Mr("close"));fe("#gripper-enable").addEventListener("click",()=>Mr("enable"));fe("#gripper-reset").addEventListener("click",()=>Mr("reset"));fe("#gripper-percentage").addEventListener("change",i=>Mr("percentage",{percentage:Number(i.target.value)}));Pd();
